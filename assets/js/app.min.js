...
// #168, #411
g()}else g()}),a.call(k)}var i,j=a.dispatch("zoom"),k=a.behavior.zoom(),l=!0,m=!0,n=!0;return h.allowPan=function(a){return arguments.length?(l=a,h):l},h.allowZoom=function(a){return arguments.length?(m=a,h):m},h.trackingLatest=function(a){return arguments.length?(n=a,h):n},h.scale=function(a){return arguments.length?(i=a,h):i},a.rebind(h,j,"on"),h}function n(){function c(b){b.each(function(c){var g=a.select(this).call(k),i=m(d).scale(f).trackingLatest(h).on("zoom",function(a){e[qa.viewChange](a)});g.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var d,e=a.dispatch(qa.viewChange),f=b.scale.dateTime(),g=a.scale.linear(),h=!0,i=60,j=b.series.multi(),k=b.chart.cartesian(f,g).plotArea(j).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:i});return c.trackingLatest=function(a){return arguments.length?(h=a,c):h},a.rebind(c,e,"on"),a.rebind(c,j,"series","mapping","decorate","key"),a.rebind(c,k,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),c.dimensionChanged=function(a){d=parseInt(a.style("width"),10)-i},c}function o(){function c(a,b){var c=g.width(b.data,"vertical");i.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",c)})}function d(a){a.each(function(d){i.snap(b.util.seriesPointSnapXOnly(g,d.data)),c(a,d);var e=b.util.extent().fields("volume").pad(.08)(d.data);e[0]<0&&(e[0]=0),j.yTickFormat(d.product.volumeFormat).trackingLatest(d.trackingLatest).xDomain(d.viewDomain).yDomain(e),a.datum(d.data).call(j)})}var e,f=a.dispatch(qa.viewChange,qa.crosshairChange),g=b.series.bar().yValue(function(a){return a.volume}),h=[],i=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?(e=a[0].datum,f.crosshairChange(a[0].datum)):(e=void 0,f.crosshairChange(void 0))}).on("trackingend",function(){f.crosshairChange(void 0)});i.id=pa.uid();var j=n().series([g,i]).yTicks(4).mapping(function(a){switch(a){case i:return h;default:return this}}).on(qa.viewChange,function(a){f[qa.viewChange](a)});return a.rebind(d,f,"on"),d.dimensionChanged=function(a){j.dimensionChanged(a)},d}function p(){function c(a){var c=a.datum();i.snap(b.util.seriesPointSnapXOnly(e,c.data)),f(c.data),j.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain([0,100]),a.datum(c.data).call(j)}var d=a.dispatch(qa.viewChange,qa.crosshairChange),e=b.indicator.renderer.relativeStrengthIndex(),f=b.indicator.algorithm.relativeStrengthIndex(),g=[e.lowerValue(),50,e.upperValue()],h=[],i=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?d.crosshairChange(a[0].datum):d.crosshairChange(void 0)}).on("trackingend",function(){d.crosshairChange(void 0)});i.id=pa.uid();var j=n().series([e,i]).yTickValues(g).mapping(function(a){switch(a){case i:return h;default:return this}}).on(qa.viewChange,function(a){d[qa.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){j.dimensionChanged(a)},c}function q(){function c(a,b){var c=g.divergenceBar().width(b.data);j.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",c)})}function d(a){var d=a.datum();j.snap(b.util.seriesPointSnapXOnly(g.divergenceBar(),d.data)),//TODO: Add to d3fc
c(a,d),h(d.data);var e=b.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(d.data.map(function(a){return a.macd}));k.trackingLatest(d.trackingLatest).xDomain(d.viewDomain).yDomain(e),a.datum(d.data).call(k)}var e=a.dispatch(qa.viewChange,qa.crosshairChange),f=b.annotation.line().value(0).label(""),g=b.indicator.renderer.macd(),h=b.indicator.algorithm.macd(),i=[],j=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?e.crosshairChange(a[0].datum):e.crosshairChange(void 0)}).on("trackingend",function(){e.crosshairChange(void 0)});j.id=pa.uid();var k=n().series([f,g,j]).yTicks(5).mapping(function(a){switch(a){case f:return[0];case j:return i;default:return this}}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi","multi"][b]})}).on(qa.viewChange,function(a){e[qa.viewChange](a)});return a.rebind(d,e,"on"),d.dimensionChanged=function(a){k.dimensionChanged(a)},d}function r(){function c(a){var b=(e.ticks()[1]-e.ticks()[0])/1e3;b<a.seconds?f.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):f.ticks(6)}function d(a){var b=a.datum();e.domain(b.viewDomain),c(b.period),a.call(f)}var e=b.scale.dateTime(),f=a.svg.axis().scale(e).orient("bottom");return d.dimensionChanged=function(a){e.range([0,parseInt(a.style("width"),10)])},d}function s(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function t(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a,b){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a,b){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n}function u(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function v(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function w(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function x(){function c(){var a=[s,j.option,t],b=p.map(function(a){return a.option});return a.concat(b,r)}function d(){switch(B.value(o),C.value(o),t.value(o),j.valueString){case"line":case"point":case"area":j.option.yValue(o)}}
// Call when what to display on the chart is modified (ie series, options)
function e(a){j=a.series,o=a.yValueAccessor.option,p=a.indicators,d(),x.series(c()),A.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function f(a){var b=j.option.width(a);r.decorate(function(a){a.classed("band hidden-xs hidden-sm",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function g(a){a.classed("band",!1).classed("hidden-xs hidden-sm",!0).selectAll("line").style("stroke-width",null)}function h(a){"candlestick"===j.valueString||"ohlc"===j.valueString?f(a):r.decorate(g)}function i(c){var d=c.datum();d.selectorsChanged&&e(d),A.xDomain(d.viewDomain),r.snap(b.util.seriesPointSnapXOnly(j.option,d.data)),h(d.data),B(d.data),C(d.data);
// Scale y axis
var f=pa.domain.filterDataInDateRange(A.xDomain(),d.data),g=w(x.series()),i=b.util.extent().fields(g).pad(.08)(f);A.yDomain(i);
// Find current tick values and add close price to this list, then set it explicitly below
var p=o(d.data[d.data.length-1]),q=v(z,[p]);A.yTickValues(q).yDecorate(function(b){var c=b.selectAll(".tick").filter(function(a){return a===p}).classed("closeLine",!0),d=18;c.select("path").attr("d",function(b){return a.svg.area()(u(l,d))}),c.select("text").attr("transform","translate("+d/2+",1)")}),s.yTicks(q.length-1),
// Redraw
A.plotArea(x),c.call(A);var t=m(k).scale(y).trackingLatest(d.trackingLatest).on("zoom",function(a){n[qa.viewChange](a)});c.select(".plot-area").call(t)}var j,k,l=60,n=a.dispatch(qa.viewChange,qa.crosshairChange),o=function(a){return a.close},p=[],q=[],r=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?n.crosshairChange(a[0].datum):n.crosshairChange(void 0)}).on("trackingend",function(){n.crosshairChange(void 0)});r.id=pa.uid();var s=b.annotation.gridline().xTicks(0),t=b.annotation.line().orient("horizontal").value(o).label("");t.id=pa.uid();var x=b.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case t:return[this.data[this.data.length-1]];case r:return q;default:return this.data}}),y=b.scale.dateTime(),z=a.scale.linear(),A=b.chart.cartesian(y,z).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:l}),B=b.indicator.algorithm.movingAverage(),C=b.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(i,n,"on"),i.dimensionChanged=function(a){k=parseInt(a.style("width"),10)-l},i}function y(){function c(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function d(a){return a.extent()[0][0]-a.extent()[1][0]===0}function e(a,c){var d=a.selectAll("defs").data([0]).enter().append("defs");d.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:g,height:j}),z.domain(b.util.extent().fields("date")(c)),A.domain(b.util.extent().fields(["low","high"]).pad(r)(c)),a.select("mask").datum(c).call(B)}function f(a){var f=a.datum();e(a,f.data),u.domain(f.viewDomain);var h=pa.domain.filterDataInDateRange(b.util.extent().fields("date")(f.data),f.data),i=b.util.extent().fields(["low","high"]).pad(r)(h);t.xDomain(b.util.extent().fields("date")(f.data)).yDomain(i),x.on("brush",function(){var b=d(x);
...
var j=m(g).scale(u).trackingLatest(f.trackingLatest).allowPan(!1).on("zoom",function(a){s[qa.viewChange](a)});a.select(".plot-area").call(j)}var g,h=100,i=40,j=h-i,k=2,l=k/2,n=j-l,o=n,p=l+o/2,q=2,r=[0,.04],s=a.dispatch(qa.viewChange),t=b.chart.cartesian(b.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:i}),u=b.scale.dateTime(),v=b.series.area().yValue(function(a){return a.close}),w=b.series.line().yValue(function(a){return a.close}),x=a.svg.brush(),y=b.series.multi().series([v,w,x]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",n).attr("y",k/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",p).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",p).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==x?this.data:void x.extent([[u.domain()[0],t.yDomain()[0]],[u.domain()[1],t.yDomain()[1]]])}),z=b.scale.dateTime(),A=a.scale.linear(),B=b.series.area().yValue(function(a){return a.close}).xScale(z).yScale(A);return a.rebind(f,s,"on"),f.dimensionChanged=function(a){g=pa.width(a.node()),u.range([0,g]),z.range([0,g]),A.range([j,0])},f}function z(){function c(b){b.each(function(b){var c=a.select(this),h=c.select("#tooltip");d=b.product.priceFormat,e=b.product.volumeFormat,f=b.period.timeFormat,c.classed("hidden",!b.data),h.layout({flexDirection:"row"}).selectAll(".tooltip").layout({marginRight:40,marginLeft:15}),b.data&&h.datum(b.data).call(g)})}var d,e,f,g=b.chart.tooltip().items([["T",function(a){return f(a.date)}],["O",function(a){return d(a.open)}],["H",function(a){return d(a.high)}],["L",function(a){return d(a.low)}],["C",function(a){return d(a.close)}],["V",function(a){return e(a.volume)}]]);return c}function A(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon bf-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(qa.indicatorChange);return a.rebind(b,c,"on"),b}function B(){function c(a){var b=a.datum(),c=b.selectedIndex||0,i=b.config,j=e(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[c].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[c].displayString});f(j,i.careted?[0]:[]);var l=g(a,[b.options]),m=h(l,b.options),n=m.enter().on("click",d.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),f=b.util.dataJoin().selector(".caret").element("span").attr("class","caret"),g=b.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),h=b.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(c,d,"on"),c}function C(a){return{displayString:a.display,option:a}}function D(){var b=a.dispatch(qa.primaryChartIndicatorChange,qa.secondaryChartChange,qa.dataProductChange),c=A().on(qa.indicatorChange,b[qa.primaryChartIndicatorChange]),d=A().on(qa.indicatorChange,b[qa.secondaryChartChange]),e=B().on("optionChange",b[qa.dataProductChange]),f=function(b){b.each(function(b){var f=a.select(this),g=b.products;f.select("#mobile-product-dropdown").datum({config:b.productConfig,options:g.map(C),selectedIndex:g.indexOf(b.selectedProduct)}).call(e),f.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),f.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(f,b,"on"),f}function E(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[qa.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(qa.resetToLatest);return a.rebind(b,c,"on"),b}function F(){var b=a.dispatch(qa.primaryChartSeriesChange,qa.primaryChartIndicatorChange,qa.secondaryChartChange),c=B().on("optionChange",b[qa.primaryChartSeriesChange]),d=B().on("optionChange",function(a){a.isPrimary?b[qa.primaryChartIndicatorChange](a):b[qa.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select(".series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select(".indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}function G(a){return{displayString:a.display,option:a}}function H(){function c(a){var c=a.datum().selectedIndex||0,f=e(a,[a.datum().options]);f.enter().append("ul");var g=f.selectAll("li").data(b.util.fn.identity);g.enter().append("li").append("a").attr("href","#").on("click",d.tabClick),g.classed("active",function(a,b){return b===c}).select("a").text(function(a){return a.displayString}),g.exit().remove()}var d=a.dispatch("tabClick"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c}function I(){var b=a.dispatch(qa.dataProductChange,qa.dataPeriodChange,qa.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=B().on("optionChange",b[qa.dataProductChange]),d=H().on("tabClick",b[qa.dataPeriodChange]),e=B().on("optionChange",b[qa.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(C),selectedIndex:h.map(function(a){return a.id}).indexOf(f.selectedProduct.id)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(G),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(G),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[qa.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f}function J(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function K(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function L(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(k,a),g[qa.newTrade](k,f)}).on("error",function(a){g[qa.streamingFeedError](a,f)}).on("close",function(a){g[qa.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var l=new Date;f.historicFeed.end(l).candles(j).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[qa.historicFeedError](a,f):(k=c(b),g[qa.historicDataLoaded](k,f),d())}))}var f,g=a.dispatch(qa.newTrade,qa.historicDataLoaded,qa.historicFeedError,qa.streamingFeedError,qa.streamingFeedClose),h=K().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=J(),j=200,k=[];return a.rebind(e,g,"on"),e}function M(){var c=a.dispatch(qa.notificationClose),d=b.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),e=b.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),f=function(b){b.each(function(b){var f=a.select(this),g=d(f,[b]);g.enter().html('<div class="messages"></div>');var h=e(g.select(".messages"),b.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){c[qa.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(f,c,"on"),f}function N(a){return{id:pa.uid(),message:a}}function O(a,b,c,d){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d}}function P(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}}function Q(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}}function R(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b}function S(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=R(a)),b}function T(){return{messages:[]}}function U(a){return{viewDomain:[],period:a}}function V(a){return{data:[],currentCrosshairData:null,viewDomain:[],trackingLatest:!0,product:a}}function W(a){var b={data:[],currentCrosshairData:null,trackingLatest:!0,viewDomain:[],selectorsChanged:!0},c=a;Object.defineProperty(b,"product",{get:function(){return c},set:function(a){c=a,b.selectorsChanged=!0}});var d=t();d.id=pa.uid();var e=s("Candlestick","candlestick",d);e.option.extentAccessor=["high","low"],Object.defineProperty(b,"series",{get:function(){return e},set:function(a){e=a,b.selectorsChanged=!0}});var f={option:function(a){return a.close}};Object.defineProperty(b,"yValueAccessor",{get:function(){return f},set:function(a){f=a,b.selectorsChanged=!0}});var g=[];return Object.defineProperty(b,"indicators",{get:function(){return g},set:function(a){g=a,b.selectorsChanged=!0}}),b}function X(){return{trackingLatest:!0}}function Y(){return{data:[],viewDomain:[],trackingLatest:!0}}function Z(a,b){return{data:void 0,product:a,period:b}}function $(a,b){return{config:a,options:b}}function _(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}}function aa(a,b){return{primaryIndicators:[],secondaryIndicators:[],productConfig:_(),products:a,selectedProduct:b}}function ba(a,b,c){return{productConfig:_(null,!0),mobilePeriodConfig:_(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[]}}function ca(){var a,c,d,e=b.data.random.financial(),f=[86400],g=null,h=function(b){c.setHours(0,0,0,0);var d=864e5;e.startDate(new Date(c-(a-1)*d));var f=e(a);b(null,f)};return h.candles=function(b){return arguments.length?(a=b,h):a},h.end=function(a){return arguments.length?(c=a,h):c},h.granularity=function(a){if(!arguments.length)return d;if(-1===f.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return d=a,h},h.product=function(a){if(!arguments.length)return h;if(null!==a)throw new Error("Random Financial Data Generator does not support products.");return g=a,h},h.apiKey=function(){throw new Error("Not implemented.")},h}function da(){var c,d=1e3,f=b.data.feed.coinbase(),g=e(function(b){var d=a.time.second.offset(f.end(),-c*f.granularity());f.start(d),f(b)},d);return g.candles=function(a){return arguments.length?(c=a,g):c},g.apiKey=function(){throw new Error("Not implemented.")},a.rebind(g,f,"end","granularity","product"),g}function ea(a){var b;return a&&(b=a.message),b}
