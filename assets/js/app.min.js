...
// In seconds
var f=86400,g=c.data.feed.coinbase.webSocket();return e.period=function(a){return arguments.length?(f=a,e):f},e.setNewProduct=function(a){return g.product(a),e},a.rebind(e,g,"product","messageType","close"),e}}(d3,fc,sc),function(a,b,c){"use strict";c.data.feed.coinbase.products=function(b,d,e,f,g){var h=[],i=null;a.json("https://api.exchange.coinbase.com/products",function(a,j){for(var k=0;k<j.length;k++)i="BTC-USD"!==j[k].id?{display:j[k].id,volumeFormat:".2f",periods:[e,f]}:{display:j[k].id,volumeFormat:".2f",periods:[b,d,e,f]},i=c.model.product(i),h.push(i);g(h)})}}(d3,fc,sc),function(a,b,c){"use strict";c.data.feed.coinbase.webSocket=function(){function a(e){a.close(),d=new WebSocket("wss://ws-feed.exchange.coinbase.com");var f={type:"subscribe",product_id:b};d.onopen=function(a){d.send(JSON.stringify(f)),e(a,null)},d.onmessage=function(a){var b=JSON.parse(a.data);if(b.type===c){var d={};d.date=new Date(b.time),d.price=parseFloat(b.price),d.volume=parseFloat(b.size),e(a,d)}},d.onerror=function(a){e(a,null)},d.onclose=function(a){e(a,null)}}var b="BTC-USD",c="match",d=null;return a.close=function(){return d&&d.close(),a},a.messageType=function(b){return arguments.length?(c=b,a):c},a.product=function(c){return arguments.length?(b=c,a):b},a}}(d3,fc,sc),function(a,b,c){"use strict";c.behavior.zoom=function(d){function e(a){
// Don't pan off sides
// Don't pan off sides
...
h()}else h()}),a.call(l)}var j,k=a.dispatch("zoom"),l=a.behavior.zoom(),m=!0,n=!0,o=!0;return i.allowPan=function(a){return arguments.length?(m=a,i):m},i.allowZoom=function(a){return arguments.length?(n=a,i):n},i.trackingLatest=function(a){return arguments.length?(o=a,i):o},i.scale=function(a){return arguments.length?(j=a,i):j},a.rebind(i,k,"on"),i}}(d3,fc,sc),function(a,b,c){"use strict";/* Credit to Chris Price for this optimisation
    ...
    */
c.series.candlestick=function(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a,b){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a,b){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n}}(d3,fc,sc),function(a,b,c){"use strict";c.app=function(){function d(){c.data.feed.coinbase.products(F,E,D,C,e)}function e(a){
// Add the newly received products to the product list
N.products=N.products.concat(a),B.app.select(".head-menu").datum(N).call(v)}function f(){R&&B.suspendLayout(!1),B.primary.datum(H).call(P.primary),B.legend.datum(O).call(P.legend),B.secondaries.datum(I).filter(function(a,b){return b<P.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+P.secondaries[c].valueString).call(P.secondaries[c].option)}),B.xAxis.datum(K).call(P.xAxis),B.navbar.datum(L).call(P.navbar),B.app.select("#navbar-reset").datum(M).call(w),B.app.select(".head-menu").datum(N).call(v),B.app.select("#selectors").datum(J).call(x),R&&(B.suspendLayout(!0),R=!1)}function g(){R=!0,c.util.layout(B,P)}function h(){a.select(window).on("resize",function(){g(),Q()})}function i(a){var b=[a[0],a[1]];H.viewDomain=b,I.viewDomain=b,K.viewDomain=b,L.viewDomain=b;var d=c.util.domain.trackingLatestData(H.viewDomain,H.data);H.trackingLatest=d,I.trackingLatest=d,L.trackingLatest=d,M.trackingLatest=d,Q()}function j(a){O.data=a,Q()}function k(){var a=H.data,d=b.util.extent().fields("date")(a),e=c.util.domain.moveToLatest(d,a,.2);i(e)}function l(a){H.data=a,I.data=a,L.data=a}function m(a){N.selectedProduct=a,H.product=a,I.product=a,O.product=a}function n(a){N.selectedPeriod=a,K.period=a,O.period=a}function o(){return c.chart.primary().on(c.event.crosshairChange,j).on(c.event.viewChange,i)}function p(){return c.chart.nav().on(c.event.viewChange,i)}function q(){return c.menu.navigationReset().on(c.event.resetToLatest,k)}function r(){return c.data.dataInterface().on(c.event.messageReceived,function(a,b){if("error"===a.type||"close"===a.type&&1e3!==a.code)console.log("Error loading data from coinbase websocket: "+a.type+" "+a.code);else if("message"===a.type&&(l(b),H.trackingLatest)){var d=c.util.domain.moveToLatest(H.viewDomain,H.data);i(d)}}).on(c.event.dataLoaded,function(a,b){a?console.log("Error getting historic data: "+a):(l(b),O.data=null,k())})}function s(a){return c.menu.head().on(c.event.dataProductChange,function(b){var c=b.option.display.substring(0,3);m(b.option),n(b.option.periods[0]),"BTC"===c?(a.setNewProduct(b.option.display),a(b.option.periods[0].seconds)):b.option===G&&a.generateDailyData(),Q()}).on(c.event.dataPeriodChange,function(b){n(b.option),a(b.option.seconds),Q()})}function t(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function u(){return c.menu.selectors().on(c.event.primaryChartSeriesChange,function(a){H.series=a,t(a,J.seriesSelector.options),Q()}).on(c.event.primaryChartIndicatorChange,function(a){a.isSelected=!a.isSelected,H.indicators=J.indicatorSelector.indicatorOptions.filter(function(a){return a.isSelected}),Q()}).on(c.event.secondaryChartChange,function(a){a.isSelected=!a.isSelected,P.secondaries=J.indicatorSelector.secondaryChartOptions.filter(function(a){return a.isSelected}),
// TODO: This doesn't seem to be a concern of menu.
P.secondaries.forEach(function(a){a.option.on(c.event.viewChange,i)}),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
B.secondaries.selectAll("*").remove(),g(),Q()})}var v,w,x,y={},z=a.select("#app-container"),A=z.select("#charts-container"),B={app:z,charts:A,primary:A.select("#primary-container"),secondaries:A.selectAll(".secondary-container"),xAxis:A.select("#x-axis-container"),navbar:A.select("#navbar-container"),legend:z.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},C=c.model.period({display:"Daily",seconds:86400,d3TimeInterval:{unit:a.time.day,value:1},timeFormat:"%b %d"}),D=c.model.period({display:"1 Hr",seconds:3600,d3TimeInterval:{unit:a.time.hour,value:1},timeFormat:"%b %d %Hh"}),E=c.model.period({display:"5 Min",seconds:300,d3TimeInterval:{unit:a.time.minute,value:5},timeFormat:"%H:%M"}),F=c.model.period({display:"1 Min",seconds:60,d3TimeInterval:{unit:a.time.minute,value:1},timeFormat:"%H:%M"}),G=c.model.product({display:"Data Generator",volumeFormat:".3s",periods:[C]}),H=c.model.primaryChart(G),I=c.model.secondaryChart(G),J=c.model.menu.selectors(),K=c.model.xAxis(C),L=c.model.nav(),M=c.model.navigationReset(),N=c.model.headMenu([G],G,C),O=c.model.legend(G,C),P={primary:void 0,secondaries:[],xAxis:c.chart.xAxis(),navbar:void 0,legend:c.chart.legend()},Q=b.util.render(f),R=!0;return y.run=function(){P.primary=o(),P.navbar=p();var a=r();v=s(a),w=q(),x=u(),g(),h(),a.generateDailyData(),d()},y}}(d3,fc,sc),function(a,b,c){"use strict";c.app().run()}(d3,fc,sc);