...
return a[0]>0&&a[1]<0}function e(){k.translate([0,0]),k.scale(1)}function f(a,b,c){return Math.min(Math.max(a,b),c)}function g(b,c,d){var e=b;return i(c[0].date)>0&&(e[0]=i.invert(i(b[0])+i(c[0].date)),e[1]=i.invert(i(b[1])+i(c[0].date))),e[0]=a.max([d[0],e[0]]),e[1]=a.min([d[1],e[1]]),e}function h(h){var o=b.util.extent().fields("date")(h.datum().data),p=i(o[0]),q=i(o[1]),r=[p,q-c];k.x(i).on("zoom",function(){var b=a.event.translate,c=b[0],p=d(r);c=f(c,-r[1],-r[0]),k.translate([c,0]);var q=1===k.scale(),s=1!==k.scale();if(q&&l||s&&m){var t=i.domain();p?t=o:s&&n&&(t=qa.domain.moveToLatest(h.datum().discontinuityProvider,t,h.datum().data)),t=g(t,h.datum().data,o),t[0].getTime()!==t[1].getTime()?j.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
e()}else e()}),h.call(k)}var i,j=a.dispatch("zoom"),k=a.behavior.zoom(),l=!0,m=!0,n=!0;return h.allowPan=function(a){return arguments.length?(l=a,h):l},h.allowZoom=function(a){return arguments.length?(m=a,h):m},h.trackingLatest=function(a){return arguments.length?(n=a,h):n},h.scale=function(a){return arguments.length?(i=a,h):i},a.rebind(h,j,"on"),h}function n(){function c(b){b.each(function(b){f.discontinuityProvider(b.discontinuityProvider);var c=a.select(this).datum(b.data).call(k),g=m(d).scale(f).trackingLatest(h).on("zoom",function(a){e[ra.viewChange](a)});c.select(".plot-area-container").datum(b).call(g)})}var d,e=a.dispatch(ra.viewChange),f=b.scale.dateTime(),g=a.scale.linear(),h=!0,i=60,j=b.series.multi(),k=b.chart.cartesian(f,g).plotArea(j).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:i});return c.trackingLatest=function(a){return arguments.length?(h=a,c):h},a.rebind(c,e,"on"),a.rebind(c,j,"series","mapping","decorate"),a.rebind(c,k,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),c.dimensionChanged=function(a){d=qa.width(a.node())-i},c}function o(){function c(a){var c=a.datum();g(c.data);var d=b.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(c.data.map(function(a){return a.macd}));h.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c).call(h)}var d=a.dispatch(ra.viewChange),e=b.annotation.line().value(0).label(""),f=b.indicator.renderer.macd(),g=b.indicator.algorithm.macd(),h=n().series([e,f]).yTicks(5).mapping(function(a){return a===e?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(ra.viewChange,function(a){d[ra.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function p(){function c(a){var b=a.datum();f(b.data),h.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b).call(h)}var d=a.dispatch(ra.viewChange),e=b.indicator.renderer.relativeStrengthIndex(),f=b.indicator.algorithm.relativeStrengthIndex(),g=[e.lowerValue(),50,e.upperValue()],h=n().series([e]).yTickValues(g).on(ra.viewChange,function(a){d[ra.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function q(){function c(a){a.each(function(c){var d=b.util.extent().fields("volume").pad(.08)(c.data);d[0]<0&&(d[0]=0),f.yTickFormat(c.product.volumeFormat).trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c).call(f)})}var d=a.dispatch(ra.viewChange),e=b.series.bar().xValue(function(a){return a.date}).yValue(function(a){return a.volume}),f=n().series([e]).yTicks(4).on(ra.viewChange,function(a){d[ra.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){f.dimensionChanged(a)},c}function r(){function c(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function d(a){return a.extent()[0][0]-a.extent()[1][0]===0}function e(a,c){var d=a.selectAll("defs").data([0]).enter().append("defs");d.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:g,height:j}),u.domain(b.util.extent().fields("date")(c)),B.domain(b.util.extent().fields(["low","high"]).pad(r)(c)),a.select("mask").datum(c).call(C)}function f(a){var f=a.datum();t.discontinuityProvider(f.discontinuityProvider),u.discontinuityProvider(f.discontinuityProvider),w.discontinuityProvider(f.discontinuityProvider),e(a,f.data),w.domain(f.viewDomain);var h=qa.domain.filterDataInDateRange(b.util.extent().fields("date")(f.data),f.data),i=b.util.extent().fields(["low","high"]).pad(r)(h);v.xDomain(b.util.extent().fields("date")(f.data)).yDomain(i),z.on("brush",function(){var b=d(z);
// Hide the bar if the extent is empty
c(a,b),b||s[ra.viewChange]([z.extent()[0][0],z.extent()[1][0]])}).on("brushend",function(){var b=d(z);c(a,!1),b&&s[ra.viewChange](qa.domain.centerOnDate(f.discontinuityProvider,w.domain(),f.data,z.extent()[0][0]))}),v.plotArea(A),a.call(v);
// Allow to zoom using mouse, but disable panning
var j=m(g).scale(w).trackingLatest(f.trackingLatest).allowPan(!1).on("zoom",function(a){s[ra.viewChange](a)});a.select(".plot-area").call(j)}var g,h=100,i=40,j=h-i,k=2,l=k/2,n=j-l,o=n,p=l+o/2,q=2,r=[0,.04],s=a.dispatch(ra.viewChange),t=b.scale.dateTime(),u=b.scale.dateTime(),v=b.chart.cartesian(t,a.scale.linear()).yTicks(0).margin({bottom:i}),w=b.scale.dateTime(),x=b.series.area().xValue(function(a){return a.date}).yValue(function(a){return a.close}),y=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),z=a.svg.brush(),A=b.series.multi().series([x,y,z]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",n).attr("y",k/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",p).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",p).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==z?this.data:void z.extent([[w.domain()[0],v.yDomain()[0]],[w.domain()[1],v.yDomain()[1]]])}),B=a.scale.linear(),C=b.series.area().xValue(function(a){return a.date}).yValue(function(a){return a.close}).xScale(u).yScale(B);return a.rebind(f,s,"on"),f.dimensionChanged=function(a){g=qa.width(a.node()),w.range([0,g]),u.range([0,g]),B.range([j,0])},f}function s(){function c(b){b.each(function(b){var c=a.select(this),h=c.select("#tooltip");d=b.product.priceFormat,e=b.product.volumeFormat,f=b.period.timeFormat,c.classed("hidden",!b.data),h.layout({flexDirection:"row"}).selectAll(".tooltip").layout({marginRight:40,marginLeft:15}),b.data&&h.datum(b.data).call(g)})}var d,e,f,g=b.chart.tooltip().items([["T",function(a){return f(a.date)}],["O",function(a){return d(a.open)}],["H",function(a){return d(a.high)}],["L",function(a){return d(a.low)}],["C",function(a){return d(a.close)}],["V",function(a){return e(a.volume)}]]);return c}function t(){function c(a){var b=(e.ticks()[1]-e.ticks()[0])/1e3;b<a.seconds?f.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):f.ticks(6)}function d(a){var b=a.datum();e.domain(b.viewDomain),e.discontinuityProvider(b.discontinuityProvider),c(b.period),a.call(f)}var e=b.scale.dateTime(),f=a.svg.axis().scale(e).orient("bottom");return d.dimensionChanged=function(a){e.range([0,qa.width(a.node())])},d}function u(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
...
return g=a.time.day.offset(g,7*l),h-=l*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function ja(){function c(){return{week1:Aa.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:Aa.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:Aa.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:Aa.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:Aa.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:Aa.data.source(ca(),null,null,null,b.scale.discontinuity.identity()),bitcoin:Aa.data.source(da(),ea,fa(),S,b.scale.discontinuity.identity()),quandl:Aa.data.source(ga(),ha,null,null,ia())}}function e(){return{generated:Aa.data.product("Data Generator","Data Generator",[j.day1],k.generated,".3s"),quandl:Aa.data.product("GOOG","GOOG",[j.day1,j.week1],k.quandl,".3s")}}function f(){var a=v();a.id=qa.uid();var c=Aa.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=qa.uid();var e=Aa.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=qa.uid();var g=Aa.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=qa.uid();var i=Aa.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=qa.uid();var k=Aa.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=Aa.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return Aa.menu.selector(l,m)}function g(){var a=ta.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=qa.uid();var d=Aa.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=qa.uid();var f=Aa.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=[d,f,Aa.menu.option("Relative Strength Index","rsi",a.rsi(),"bf-icon-rsi-indicator",!1),Aa.menu.option("MACD","macd",a.macd(),"bf-icon-macd-indicator",!1),Aa.menu.option("Volume","volume",a.volume(),"bf-icon-bar-series",!1)];return g}function h(){var a=Aa.menu.dropdownConfig("Add Indicator",!1,!0);return Aa.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}var j=c(),k=d(),l=e();return{periods:j,sources:k,primaryChart:Aa.chart.primary(l.generated,l.generated.source.discontinuityProvider),secondaryChart:Aa.chart.secondary(l.generated,l.generated.source.discontinuityProvider),selectors:i(),xAxis:Aa.chart.xAxis(j.day1,l.generated.source.discontinuityProvider),nav:Aa.chart.nav(l.generated.source.discontinuityProvider),navReset:Aa.chart.navigationReset(),headMenu:Aa.menu.head([l.generated,l.quandl],l.generated,j.day1),legend:Aa.chart.legend(l.generated,j.day1),overlay:Aa.menu.overlay([l.generated,l.quandl],l.generated),notificationMessages:Aa.notification.messages()}}function ka(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function la(a,b,c,d){return a.map(function(a){return Aa.data.product(a.id,a.id,d.get(a.id)||c,b)})}function ma(){function c(){X&&(X=!1),Z&&H.suspendLayout(!1),H.primary.datum(R.primaryChart).call(U.primary),H.legend.datum(R.legend).call(U.legend),H.secondaries.datum(R.secondaryChart).filter(function(a,b){return b<U.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container secondary-"+U.secondaries[c].valueString).call(U.secondaries[c].option)}),H.xAxis.datum(R.xAxis).call(U.xAxis),H.navbar.datum(R.nav).call(U.navbar),H.app.select("#navbar-reset").datum(R.navReset).call(K),H.app.select(".head-menu").datum(R.headMenu).call(J),H.app.selectAll(".selectors").datum(R.selectors).call(M),H.app.select("#notifications").datum(R.notificationMessages).call(O),H.overlay.datum(R.overlay).call(I),Z&&(H.suspendLayout(!0),Z=!1)}function d(){Z=!0,qa.layout(H,U)}function e(){a.select(window).on("resize",function(){d(),Y()})}function f(a){R.notificationMessages.messages.unshift(N(a))}function g(a){var b=[a[0],a[1]];R.primaryChart.viewDomain=b,R.secondaryChart.viewDomain=b,R.xAxis.viewDomain=b,R.nav.viewDomain=b;var c=qa.domain.trackingLatestData(R.primaryChart.viewDomain,R.primaryChart.data);R.primaryChart.trackingLatest=c,R.secondaryChart.trackingLatest=c,R.nav.trackingLatest=c,R.navReset.trackingLatest=c,Y()}function h(a){a.isSelected=!a.isSelected,A(),Y()}function i(a){a.isSelected=!a.isSelected,C(),Y()}function j(a){R.legend.data=a,Y()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):S(a),c&&(f(c),Y())}function l(){var a=R.primaryChart.data,c=b.util.extent().fields("date")(a),d=qa.domain.moveToLatest(R.primaryChart.discontinuityProvider,c,a,W);g(d)}function m(a,b){var c='<div class="spinner"></div>',d='<div class="content alert alert-info">'+b+"</div>";H.app.select("#loading-status-message").classed("hidden",!(a||b)).html(b?d:c)}function n(a){R.primaryChart.data=a,R.secondaryChart.data=a,R.nav.data=a}function o(a){var b=a.discontinuityProvider;R.xAxis.discontinuityProvider=b,R.nav.discontinuityProvider=b,R.primaryChart.discontinuityProvider=b,R.secondaryChart.discontinuityProvider=b}function p(a){R.headMenu.selectedProduct=a,R.primaryChart.product=a,R.secondaryChart.product=a,R.legend.product=a,R.overlay.selectedProduct=a,o(a.source)}function q(a){R.headMenu.selectedPeriod=a,R.xAxis.period=a,R.legend.period=a}function r(a){m(!0),p(a),q(a.periods[0]),T(a.periods[0].seconds,a)}function s(){return ta.primary().on(ra.crosshairChange,j).on(ra.viewChange,g)}function t(){return ta.nav().on(ra.viewChange,g)}function u(){return ua.navigationReset().on(ra.resetToLatest,l)}function v(){return L().on(ra.newTrade,function(a,b){if(n(a),R.primaryChart.trackingLatest){var c=qa.domain.moveToLatest(R.primaryChart.discontinuityProvider,R.primaryChart.viewDomain,R.primaryChart.data);g(c)}}).on(ra.historicDataLoaded,function(a,b){m(!1),n(a),R.legend.data=null,l(),d()}).on(ra.historicFeedError,function(a,b){m(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),e=b.historicNotificationFormatter(d);e&&(c=". "+e)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;f(i),Y()}).on(ra.streamingFeedError,k).on(ra.streamingFeedClose,k)}function w(){return ua.head().on(ra.dataProductChange,function(a){r(a.option),Y()}).on(ra.dataPeriodChange,function(a){m(!0),q(a.option),T(a.option.seconds),Y()}).on(ra.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){R.primaryChart.indicators.forEach(y),U.secondaries.forEach(y),A(),C(),Y()})}function x(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function y(a){a.isSelected=!1}function z(){return ua.selectors().on(ra.primaryChartSeriesChange,function(a){R.primaryChart.series=a,x(a,R.selectors.seriesSelector.options),Y()}).on(ra.primaryChartIndicatorChange,h).on(ra.secondaryChartChange,i)}function A(){R.primaryChart.indicators=R.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),R.overlay.primaryIndicators=R.primaryChart.indicators}function B(){U.secondaries=R.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
U.secondaries.forEach(function(a){a.option.on(ra.viewChange,g)}),R.overlay.secondaryIndicators=U.secondaries}function C(){B(),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
H.secondaries.selectAll("*").remove(),d()}function D(){return ua.overlay().on(ra.primaryChartIndicatorChange,h).on(ra.secondaryChartChange,i).on(ra.dataProductChange,function(a){r(a.option),Y()})}function E(a){R.notificationMessages.messages=R.notificationMessages.messages.filter(function(b){return b.id!==a}),Y()}function F(){return va.toast().on(ra.notificationClose,E)}function G(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;R.notificationMessages.messages.unshift(N(e))}else{var f=[R.periods.hour1,R.periods.day1],g=a.map();g.set("BTC-USD",[R.periods.minute1,R.periods.minute5,R.periods.hour1,R.periods.day1]);var h=la(c,R.sources.bitcoin,f,g);R.headMenu.products=R.overlay.products=R.headMenu.products.concat(h)}Y()}var H,I,J,K,M,O,P='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',Q={},R=ja(),T=v(),U={primary:void 0,secondaries:[],xAxis:ta.xAxis(),navbar:void 0,legend:ta.legend()},V=!1,W=.2,X=!0,Y=b.util.render(c),Z=!0;return Q.fetchCoinbaseProducts=function(a){return arguments.length?(V=a,Q):V},Q.changeQuandlProduct=function(a){var b=wa.product(a,a,[R.periods.day1],R.sources.quandl,".3s"),c=R.headMenu.products.some(function(a){return a.id===b.id}),d=R.overlay.products.some(function(a){return a.id===b.id});c||R.headMenu.products.push(b),d||R.overlay.products.push(b),r(b),X||Y()},Q.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(W=a,Q):W},Q.indicators=function(a){if(!arguments.length){var b=[];return R.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return R.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),A(),X?B():(C(),Y()),Q},Q.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(P);var f=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");H={app:c,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},U.primary=s(),U.navbar=t(),J=w(),K=u(),M=z(),I=D(),O=F(),d(),e(),T(R.headMenu.selectedPeriod.seconds,R.headMenu.selectedProduct),V?ka(G):R.sources.bitcoin&&delete R.sources.bitcoin},b.util.rebind(Q,R.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),b.util.rebind(Q,T,{periodsOfDataToFetch:"candlesOfData"}),Q}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c;var na={centerOnDate:d,filterDataInDateRange:e,moveToLatest:f,trackingLatestData:g},oa=!1,pa=0,qa={domain:na,layout:h,uid:i,width:j,debounce:k,throttle:l},ra={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},sa={base:n,macd:o,rsi:p,volume:q},ta={legend:s,nav:r,primary:z,xAxis:t,secondary:sa},ua={head:E,selectors:F,navigationReset:G,overlay:I},va={toast:M},wa={period:O,product:P,source:Q},xa={head:U,periodAdaptor:B,productAdaptor:A,overlay:V,dropdownConfig:T,option:u,selector:W},ya={legend:X,nav:Y,navigationReset:Z,primary:$,secondary:_,xAxis:aa},za={message:N,messages:ba},Aa={menu:xa,chart:ya,data:wa,notification:za},Ba={app:ma},Ca=window.location.search.split("seed=")[1];Ca&&Math.seedrandom(Ca),Ba.app().fetchCoinbaseProducts(!0).run("#app-container")});