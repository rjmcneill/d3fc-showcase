...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(require("d3")):"function"==typeof define&&define.amd?define(["d3"],b):b(a.d3)}(this,function(a){"use strict";function b(a,b){return b={exports:{}},a(b,b.exports),b.exports}/**
	 ...
	 * object names.
	 */
function c(b,c,d){return"object"!=typeof d?a.rebind.apply(a,arguments):(Object.keys(d).forEach(function(a){var e=c[d[a]];if("function"!=typeof e)throw new Error("The method "+d[a]+" does not exist on the source object");b[a]=function(){var a=e.apply(c,arguments);return a===c?b:a}}),b)}function d(a){return a[0].toUpperCase()+a.slice(1)}/**
	 ...
	 * be rebound.
	 */
function e(a,b,e,f){function g(a){return f.some(function(b){return a.match(b)})}function h(a){return""!==e?e+d(a):a}e="undefined"!=typeof e?e:"",4===arguments.length&&Array.isArray(f)||(f=Array.prototype.slice.call(arguments,3)),f=f.map(function(a){if("string"==typeof a){if(!b.hasOwnProperty(a))throw new Error("The method "+a+" does not exist on the source object");a=new RegExp("^"+a+"$")}return a});var i={};for(var j in b)b.hasOwnProperty(j)&&!g(j)&&(i[h(j)]=j);c(a,b,i)}function f(a,b){return a.map(function(a){return[b(a),a]}).reduce(function(a,b){return a[0]>b[0]?b:a},[Number.MAX_VALUE,null])[1]}function g(a,b){return!(a.x>=b.x+b.width||a.x+a.width<=b.x||a.y>=b.y+b.height||a.y+a.height<=b.y)}function h(a,b){var c=Math.max(a.x,b.x),d=Math.min(a.x+a.width,b.x+b.width),e=Math.max(a.y,b.y),f=Math.min(a.y+a.height,b.y+b.height);return(d-c)*(f-e)}function i(a,b){var c=a[b];
// Filter all rectangles that aren't the selected rectangle
// and the filter if they intersect.
return a.filter(function(a,c){return b!==c}).filter(function(a){return g(a,c)})}function j(b,c){var d=b[c],e=i(b,c);return a.sum(e.map(function(a){return h(d,a)}))}function k(b){return a.sum(b.map(function(a,c){return j(b,c)}))}function l(){var a=0,b=0,c=function(c){return!(c.x<0||c.y<0||c.x>a||c.y>b||c.x+c.width>a||c.y+c.height>b)};return c.containerWidth=function(b){return arguments.length?(a=b,c):a},c.containerHeight=function(a){return arguments.length?(b=a,c):b},c}function m(a){var b=a.x,c=a.y,d=a.width,e=a.height;return[n(b,c,d,e),// Same location
n(b-d,c,d,e),// Left
n(b-d,c-e,d,e),// Up, left
n(b,c-e,d,e),// Up
n(b,c-e/2,d,e),// Half up
n(b-d/2,c,d,e),// Half left
n(b-d,c-e/2,d,e),// Full left, half up
n(b-d/2,c-e,d,e)]}function n(a,b,c,d){return{x:a,y:b,width:c,height:d}}function o(a){return a[p(a)]}function p(a){return Math.floor(Math.random()*a.length)}function q(a,b,c){var d=a.slice();return d[b]=c,d}function r(){function b(a,b){
// For one point choose a random other placement.
var c=p(a),d=a[c],e=m(d),f=o(e);return q(b,c,f)}function c(a){for(var b=k(a),c=1,e=0;e<a.length;e++){var f=a[e];c+=d(f)?0:100}return b*c}var d=l(),e=1e3,f=1,g=function(a){for(var d=a,g=a,h=1/0,i=e;i>0;){var j=b(d,g),k=c(j),l=Math.exp((h-k)/i);(h>k||l>Math.random())&&(g=j,h=k),i-=f}return g};return g.temperature=function(a){return arguments.length?(e=a,g):e},g.cooling=function(a){return arguments.length?(f=a,g):f},a.rebind(g,d,"containerWidth"),a.rebind(g,d,"containerHeight"),g}function s(){function b(a,b){
// Find rectangles with collisions or are outside of the bounds of the container
return b.map(function(a,b){return[a,b]}).filter(function(a,d){return i(b,a[1]).length||!c(a[0])}).forEach(function(d){
// Use original data to stop wandering rectangles with each iteration
var e=m(a[d[1]]),g=e.map(function(a){return q(b,d[1],a)}),h=f(g,function(a){var b=j(a,d[1]),e=c(a[d[1]]);return b+(e?0:Number.MAX_VALUE)});b=h}),b}var c=l(),d=1,e=function(a){
// Keep going until there's no more iterations to do or
// the solution is a local minimum
for(var c=a,e=a,f=Number.MAX_VALUE,g=1/0,h=0;d>h&&g>f;)g=f,e=b(c,e),f=k(e),h++;return e};return e.iterations=function(a){return arguments.length?(d=a,e):d},a.rebind(e,c,"containerWidth"),a.rebind(e,c,"containerHeight"),e}function t(){function b(a,b){var c=a.slice();return c.push(b),c}function c(a){for(var b=k(a),c=!0,e=0;e<a.length&&c;e++){var f=a[e];c=d(f)}return b+(c?0:1/0)}var d=l(),e=function(a){var d=[];return a.forEach(function(a){var e=m(a),g=e.map(function(a){return b(d,a)});d=f(g,c)}),d};return a.rebind(e,d,"containerWidth"),a.rebind(e,d,"containerHeight"),e}function u(){var a=1,b=1,c=function(c){return c.map(function(c,d){var e=c.x,f=c.y;return e+c.width>a&&(e-=c.width),f+c.height>b&&(f-=c.height),{x:e,y:f}})};return c.containerWidth=function(b){return arguments.length?(a=b,c):a},c.containerHeight=function(a){return arguments.length?(b=a,c):b},c}function v(){return this}function w(a){return a}function x(a,b){return b}function y(a){}
// Wrapper around d3's selectAll/data data-join, which allows decoration of the result.
// This is achieved by appending the element to the enter selection before exposing it.
// A default transition of fade in/out is also implicitly added but can be modified.
function z(){var b="g",c=!1,d="g",e={},f=x,g=function(g,h){var i=h||w;
...
function C(a,b){A(a)?a.rangePoints(b,1):a.range(b)}
...
function D(b){var c=b.map(function(b){return a.functor(b)});return function(a,b){return c.map(function(c){return c(a,b)})}}function E(b){var c=a.functor([0,0]),d=function(a,b){return[a.x,a.y]},f=a.scale.identity(),g=a.scale.identity(),h=y,i=b||w,j=y,k=z().selector("g.rectangle").element("g").attr("class","rectangle"),l=function(a){var b=B(f),e=B(g);i.containerWidth&&i.containerWidth(Math.max(b[0],b[1])),i.containerHeight&&i.containerHeight(Math.max(e[0],e[1])),a.each(function(a,b){var e=k(this,a),f=a.map(function(a,b){var e=d(a,b),f=c(a,b);return{x:e[0],y:e[1],width:f[0],height:f[1]}}),g=i(f);
// offset each rectangle accordingly
e.attr("transform",function(a,b){var c=g[b];return"translate("+c.x+", "+c.y+")"}),
// set the anchor-point for each rectangle
a.forEach(function(a,b){var c=d(a,b),e=[c[0]-g[b].x,c[1]-g[b].y];h(a,b,e)}),
// set the layout width / height so that children can use SVG layout if required
e.attr({"layout-width":function(a,b){return f[b].width},"layout-height":function(a,b){return f[b].height}}),e.call(j)})};return e(l,i),l.size=function(a){return arguments.length?(c=D(a),l):c},l.position=function(a){return arguments.length?(d=D(a),l):d},l.anchor=function(a){return arguments.length?(h=a,l):h},l.xScale=function(a){return arguments.length?(f=a,l):f},l.yScale=function(a){return arguments.length?(g=a,l):g},l.component=function(a){return arguments.length?(j=a,l):j},l}/* global requestAnimationFrame:false */
// Debounce render to only occur once per frame
function F(a){var b=null;return function(){null==b&&(b=requestAnimationFrame(function(){b=null,a()}))}}function G(a,b){return function(a,b){return{x:a,y:b}}}function H(a,b,c,d,e,f){
// a default function that computes the distance between two points
return f=f||function(a,b,c,d){var e=a-c,f=b-d;return e*e+f*f},function(g,h){var i=e.map(function(e){var i=f(g,h,a(c(e)),b(d(e)));return[i,e]}).reduce(function(a,b){return a[0]>b[0]?b:a},[Number.MAX_VALUE,null])[1];return{datum:i,x:i?a(c(i)):g,y:i?b(d(i)):h}}}function I(a,b,c){return function(d,e){var f=a.xScale(),g=a.yScale(),h=a.xValue(),i=(a.yValue||a.yCloseValue).call(a);return H(f,g,h,i,b,c)(d,e)}}function J(a,b){function c(a,b,c,d){var e=a-c;return Math.abs(e)}return I(a,b,c)}function K(a,b){function c(a,b,c,d){var e=b-d;return Math.abs(e)}return I(a,b,c)}
// returns the width and height of the given element minus the padding.
function L(a){var b=a.ownerDocument.defaultView.getComputedStyle(a);return{width:parseFloat(b.width)-parseFloat(b.paddingLeft)-parseFloat(b.paddingRight),height:parseFloat(b.height)-parseFloat(b.paddingTop)-parseFloat(b.paddingBottom)}}
...
// by the given factor
function M(b){return function(c){
...
var d=a.pairs(c).map(function(a){return Math.abs(a[0]-a[1])}),e=a.min(d);return b*e}}/**
	 ...
	 * @memberof fc.util
	 */
function N(){var b=[],c=null,d="percent",e=0,f=null,g=function(g){
// we need an array of arrays if we don't have one already
Array.isArray(g[0])||(g=[g]),
// the fields can be a mixed array of property names or accessor functions
b=b.map(function(a){return"string"!=typeof a?a:function(b){return b[a]}});var h=a.min(g,function(c){return a.min(c,function(c){return a.min(b.map(function(a){return a(c)}))})}),i=a.max(g,function(c){return a.max(c,function(c){return a.max(b.map(function(a){return a(c)}))})}),j="[object Date]"===Object.prototype.toString.call(h),k=j?h.getTime():h,l=j?i.getTime():i;
// apply symmetry rules
if(null!=f){var m=j?f.getTime():f,n=Math.abs(l-m),o=Math.abs(k-m),p=Math.max(n,o);k=m-p,l=m+p}if("domain"===d)
// pad absolutely
Array.isArray(e)?(k-=e[0],l+=e[1]):(k-=e,l+=e);else if("percent"===d)
// pad percentagely
if(Array.isArray(e)){var q=[e[0]*(l-k),e[1]*(l-k)];k-=q[0],l+=q[1]}else{var r=e*(l-k)/2;k-=r,l+=r}
// Return the smallest and largest
// Include the specified point in the range
return null!==c&&(k>c?k=c:c>l&&(l=c)),j&&(k=new Date(k),l=new Date(l)),[k,l]};/*
	    * @param {array} fields the names of object properties that represent field values, or accessor functions.
	    */
return g.fields=function(a){
// the fields parameter must be an array of field names,
// but we can pass non-array types in
return arguments.length?(Array.isArray(a)||(a=[a]),b=a,g):b},g.include=function(a){return arguments.length?(c=a,g):c},g.padUnit=function(a){return arguments.length?(d=a,g):d},g.pad=function(a){return arguments.length?(e=a,g):e},g.symmetricalAbout=function(a){return arguments.length?(f=a,g):f},g}
...
function T(){var b=a.time.scale(),c=a.scale.linear(),d=[],e=v,f=x,g=y,h=z().selector("g.multi").children(!0).attr("class","multi").element("g").key(function(a,b){
...
a.selection.prototype.order.call(i),g(i)})};return i.xScale=function(a){return arguments.length?(b=a,i):b},i.yScale=function(a){return arguments.length?(c=a,i):c},i.series=function(a){return arguments.length?(d=a,i):d},i.mapping=function(a){return arguments.length?(e=a,i):e},i.key=function(a){return arguments.length?(f=a,i):f},i.decorate=function(a){return arguments.length?(g=a,i):g},i}function U(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close};return b.x0=function(a,b){return c(f(a,b))},b.y0=function(a,b){return d(e(a,b))},b.x=b.x1=function(a,b){return c(g(a,b))},b.y=b.y1=function(a,b){return d(h(a,b))},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.x0Value=function(c){return arguments.length?(f=a.functor(c),b):f},b.y0Value=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=b.x1Value=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=b.y1Value=function(c){return arguments.length?(h=a.functor(c),b):h},b}function V(){var b=y,c=a.svg.symbol(),d=U(),e=z().selector("g.point").element("g").attr("class","point"),f=function(a,b){return"translate("+d.x(a,b)+", "+d.y(a,b)+")"},g=function(a){a.each(function(a,g){var h=a.filter(d.defined),i=e(this,h);i.enter().attr("transform",f).append("path"),i.attr("transform",f).select("path").attr("d",c),b(i,a,g)})};return g.decorate=function(a){return arguments.length?(b=a,g):b},a.rebind(g,d,"xScale","xValue","yScale","yValue"),a.rebind(g,e,"key"),a.rebind(g,c,"size","type"),g}function W(){
...
// these annotations.
function b(b){return a.scale.identity().range(B(b))}function d(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e.push(d),c.call(r),g.trackingstart.apply(this,arguments)}function e(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e[e.length-1]=d,c.call(r),g.trackingmove.apply(this,arguments)}function f(){var b=a.select(this),c=b.datum();c.pop(),b.call(r),g.trackingend.apply(this,arguments)}var g=a.dispatch("trackingstart","trackingmove","trackingend"),h=a.time.scale(),i=a.scale.linear(),j=function(a,b){return G(h,i)(a,b)},k=y,l=function(a){return a.x},m=function(a){return a.y},n=z().children(!0).selector("g.crosshair").element("g").attr("class","crosshair"),o=V().xValue(l).yValue(m),p=S().value(m).label(function(a){return a.y}),q=S().orient("vertical").value(l).label(function(a){return a.x}),r=function(c){c.each(function(c,g){var j=a.select(this).style("pointer-events","all").on("mouseenter.crosshair",d).on("mousemove.crosshair",e).on("mouseleave.crosshair",f),l=j.selectAll("rect").data([c]);l.enter().append("rect").style("visibility","hidden"),j.select("rect").attr("x",B(h)[0]).attr("y",B(i)[1]).attr("width",B(h)[1]).attr("height",B(i)[0]);var m=n(j,c);m.enter().style("pointer-events","none");var r=T().series([p,q,o]).xScale(b(h)).yScale(b(i)).mapping(function(){return[this]});m.call(r),k(m,c,g)})};return r.xScale=function(a){return arguments.length?(h=a,r):h},r.yScale=function(a){return arguments.length?(i=a,r):i},r.snap=function(a){return arguments.length?(j=a,r):j},r.decorate=function(a){return arguments.length?(k=a,r):k},a.rebind(r,g,"on"),c(r,p,{yLabel:"label"}),c(r,q,{xLabel:"label"}),r}
// Renders an error bar series as an SVG path based on the given array of datapoints.
function X(){var b=function(a,b){return a.x},c=function(a,b){return a.y},d=function(a,b){return a.errorHigh},e=function(a,b){return a.errorLow},f="vertical",g=a.functor(5),h=function(a){return a.map(function(a,h){var i=g(a,h)/2,j=d(a,h)-e(a,h),k=c(a,h)-e(a,h),l=d(a,h)-c(a,h),m=b(a,h)-e(a,h),n=d(a,h)-b(a,h),o="",p="";if("vertical"===f){var q="h"+-i+"h"+2*i+"h"+-i,r="v"+-j;o="M0,"+k+q+r+q+"M0,"+l}else{var s="v"+-i+"v"+2*i+"v"+-i,t="h"+-j;p="M"+m+",0"+s+t+s+"M"+n+",0"}return o+p}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.y=function(b){return arguments.length?(c=a.functor(b),h):c},h.errorHigh=function(b){return arguments.length?(d=a.functor(b),h):d},h.errorLow=function(b){return arguments.length?(e=a.functor(b),h):e},h.barWidth=function(b){return arguments.length?(g=a.functor(b),h):g},h.orient=function(a){return arguments.length?(f=a,h):f},h}
// Renders an OHLC as an SVG path based on the given array of datapoints. Each
// OHLC has a fixed width, whilst the x, open, high, low and close positions are
// obtained from each point via the supplied accessor functions.
function Y(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h)/2,o="M"+i+","+l,p="V"+k,q="M"+i+","+j+"h"+-n,r="M"+i+","+m+"h"+n;return o+p+q+r}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.open=function(b){return arguments.length?(c=a.functor(b),h):c},h.high=function(b){return arguments.length?(d=a.functor(b),h):d},h.low=function(b){return arguments.length?(e=a.functor(b),h):e},h.close=function(b){return arguments.length?(f=a.functor(b),h):f},h.width=function(b){return arguments.length?(g=a.functor(b),h):g},h}
...
// obtained from each point via the supplied accessor functions.
function Z(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h),o="M"+(i-n/2)+","+j+
// Draw the width
"h"+n+
...
// the bound data
function b(a,b){return function(c){return b(a(c),0)}}function c(a,b){return e()?"translate("+b+", "+a+")":"translate("+a+", "+b+")"}function d(a){return e()?a.map(function(a){return[a[1],a[0]]}):a}function e(){return"left"===i||"right"===i}function f(a,b){return g[a]?g[a].apply(g,j):b}var g=a.scale.identity(),h=y,i="bottom",j=[10],k=null,l=null,m=6,n=6,o=3,p=a.svg.line(),q=z().selector("g.tick").element("g").key(w).attr("class","tick"),r=z().selector("path.domain").element("path").attr("class","domain"),s=function(e){e.each(function(e,j){
// Stash a snapshot of the new scale, and retrieve the old snapshot.
var s=this.__chart__||g;this.__chart__=g.copy();var t=null==k?f("ticks",g.domain()):k,u=null==l?f("tickFormat",w):l,v="bottom"===i||"right"===i?1:-1,x=a.select(this),y=B(g),z=d([[y[0],v*m],[y[0],0],[y[1],0],[y[1],v*m]]),C=r(x,[e]);C.attr("d",p(z)),
...
transform:b(A(g)?g:s,c)});var D=q(x,t);
// enter
...
A(g)||D.exit().attr("transform",b(g,c)),h(D,e,j)})};return s.scale=function(a){return arguments.length?(g=a,s):g},s.ticks=function(a){return arguments.length?(j=arguments,s):j},s.tickValues=function(a){return arguments.length?(k=a,s):k},s.tickFormat=function(a){return arguments.length?(l=a,s):l},s.tickSize=function(a){var b=arguments.length;return b?(n=Number(a),m=Number(arguments[b-1]),s):n},s.innerTickSize=function(a){return arguments.length?(n=Number(a),s):n},s.outerTickSize=function(a){return arguments.length?(m=Number(a),s):m},s.tickPadding=function(a){return arguments.length?(o=a,s):o},s.orient=function(a){return arguments.length?(i=a,s):i},s.decorate=function(a){return arguments.length?(h=a,s):h},s}function aa(){var a="",b=function(a){return a.y},c=!1,d=function(a,b,c){return b===c.length-1?"Final":void 0},e={up:"up",down:"down",unchanged:"unchanged"},f=function(f){var g,h,i,j=f.length,k=0,l=0,m=[];for(c&&(l=b(f[0]),m.push({x:f[0][a],y0:0,y1:l,direction:e.unchanged}),k=1),k;j>k;k+=1)g=l,h=b(f[k])+l,m.push({x:f[k][a],y0:g,y1:h,direction:h-g>0?e.up:e.down}),i=d(f[k],k,f),i&&m.push({x:i,y0:0,y1:h,direction:e.unchanged}),l=h;return m};return f.xValueKey=function(b){return arguments.length?(a=b,f):a},f.yValue=function(a){return arguments.length?(b=a,f):b},f.total=function(a){return arguments.length?(d=a,f):d},f.startsWithTotal=function(a){return arguments.length?(c=a,f):c},f}
...
function ba(){function b(a,b){return"vertical"===i?"translate("+k.x1(a,b)+", "+k.y0(a,b)+")":"translate("+k.x0(a,b)+", "+k.y1(a,b)+")"}function c(a,b){return"vertical"===i?k.y1(a,b)-k.y0(a,b):k.x1(a,b)-k.x0(a,b)}function d(a){return"vertical"===i?a.height:a.width}function e(a){return"vertical"===i?a.width:a.height}function f(){return"vertical"===i?k.x:k.y}var g=y,h=M(.75),i="vertical",j=$(),k=U().xValue(function(a,b){return"vertical"===i?a.date:a.close}).yValue(function(a,b){return"vertical"===i?a.close:a.date}),l=z().selector("g.bar").element("g"),m=function(a){a.each(function(a,m){if("vertical"!==i&&"horizontal"!==i)throw new Error("The bar series does not support an orientation of "+i);l.attr("class","bar "+i);var n=a.filter(k.defined);j.x(0).y(0).width(0).height(0),"vertical"===i?j.verticalAlign("top"):j.horizontalAlign("right");
...
d(j)(c),p.attr("transform",b).select("path").attr("d",function(a){return j([a])}),g(p,n,m)})};return m.decorate=function(a){return arguments.length?(g=a,m):g},m.barWidth=function(b){return arguments.length?(h=a.functor(b),m):h},m.orient=function(a){return arguments.length?(i=a,m):i},a.rebind(m,k,"xScale","xValue","x1Value","x0Value","yScale","yValue","y1Value","y0Value"),a.rebind(m,l,"key"),m}function ca(){function a(){return"vertical"===b.orient()}var b=ba(),c=function(c){b.xValue(function(b,c){return a()?b.x:b.y1}).yValue(function(b,c){return a()?b.y1:b.x}).x0Value(function(b,c){return a()?0:b.y0}).y0Value(function(b,c){return a()?b.y0:0}).decorate(function(a,c,d){a.enter().attr("class","waterfall "+b.orient()).classed("up",function(a){return"up"===a.direction}).classed("down",function(a){return"down"===a.direction})}),b(c)};return e(c,b),c}function da(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close},i="vertical",j=a.functor(5);return b.width=function(a,b){return j("vertical"===b?a.map(function(a,b){return c(g(a,b))}):a.map(function(a,b){return d(h(a,b))}))},b.values=function(a,b){return"vertical"===i?{x:c(g(a,b)),y:d(h(a,b)),errorHigh:d(e(a,b)),errorLow:d(f(a,b))}:{x:c(g(a,b)),y:d(h(a,b)),errorHigh:c(e(a,b)),errorLow:c(f(a,b))}},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.orient=function(a){return arguments.length?(i=a,b):i},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.errorLow=function(c){return arguments.length?(f=a.functor(c),b):f},b.errorHigh=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=function(c){return arguments.length?(h=a.functor(c),b):h},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function ea(){var b=y,c=5,d="vertical",f=da(),g=z().selector("g.errorBar").element("g").attr("class","errorBar"),h=function(c){f.orient(h.orient()),c.each(function(c,d){var e=c.filter(f.defined),i=g(this,e);i.enter().append("path");var j=X().orient(h.orient()).barWidth(f.width(e));i.each(function(b,c){var d=f.values(b,c),e=a.select(this).attr("transform","translate("+d.x+", "+d.y+")");j.x(d.x).errorHigh(d.errorHigh).errorLow(d.errorLow).y(d.y),e.select("path").attr("d",j([b])).attr("stroke","black")}),b(i,c,d)})};return h.barWidth=function(a){return arguments.length?(c=a,h):c},h.orient=function(a){return arguments.length?(d=a,h):d},h.decorate=function(a){return arguments.length?(b=a,h):b},a.rebind(h,g,"key"),e(h,f),h}function fa(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=function(a,b){return a.date},f=function(a,b){return a.open},g=function(a,b){return a.high},h=function(a,b){return a.low},i=function(a,b){return a.close},j=M(.75),k=function(a,b){return c(e(a,b))};return b.width=function(a){return j(a.map(k))},b.defined=function(a,b){return null!=e(a,b)&&null!=f(a,b)&&null!=h(a,b)&&null!=g(a,b)&&null!=i(a,b)},b.values=function(a,b){var c=i(a,b),e=f(a,b),j="";return c>e?j="up":e>c&&(j="down"),{x:k(a,b),yOpen:d(e),yHigh:d(g(a,b)),yLow:d(h(a,b)),yClose:d(c),direction:j}},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.xValue=function(a){return arguments.length?(e=a,b):e},b.yOpenValue=function(a){return arguments.length?(f=a,b):f},b.yHighValue=function(a){return arguments.length?(g=a,b):g},b.yLowValue=function(a){return arguments.length?(h=a,b):h},b.yValue=b.yCloseValue=function(a){return arguments.length?(i=a,b):i},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function ga(){var b=ba(),c=M(.75),d=y,e=a.scale.linear(),f=a.scale.linear(),g=function(a){return a.values},h=z().selector("g.stacked").element("g").attr("class","stacked"),i=function(a,c){return e(b.xValue()(a,c))},j=function(j){j.each(function(j){var k=c(g(j[0]).map(i)),l=k/(j.length-1);b.barWidth(l);var m=k/2;f.domain([0,j.length-1]).range([-m,m]);var n=h(this,j);n.enter().append("g"),n.select("g").datum(g).each(function(c,g){var h=a.select(this),i=function(a){return e(a)+f(g)};b.xScale(i),
// adapt the decorate function to give each series the correct index
b.decorate(function(a,b){d(a,b,g)}),h.call(b)})})};return j.decorate=function(a){return arguments.length?(d=a,j):d},j.xScale=function(a){return arguments.length?(e=a,j):e},j.values=function(a){return arguments.length?(g=a,j):g},a.rebind(j,b,"yValue","xValue","yScale"),j}function ha(){var b=y,c=U(),d=a.svg.line().defined(c.defined).x(c.x).y(c.y),e=z().selector("path.line").element("path").attr("class","line"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function ia(){var b=y,c=function(a){return a.values},d=function(d){d.each(function(d){var e=a.select(this),f=z().selector("g.stacked").element("g").attr("class","stacked"),g=f(e,d);g.enter().append("g"),g.select("g").datum(c).call(b)})};return d.series=function(a){return arguments.length?(b=a,d):b},d.values=function(a){return arguments.length?(c=a,d):c},d}function ja(){var a=ha().yValue(function(a){return a.y0+a.y}),b=ia().series(a),c=function(a){a.call(b)};return e(c,a),c}function ka(){var a=ba().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=ia().series(a),c=function(a){a.call(b)};return e(c,a),c}function la(){var b=y,c=U(),d=a.svg.area().defined(c.defined).x(c.x).y0(c.y0).y1(c.y1),e=z().selector("path.area").element("path").attr("class","area"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue","y1Value","y0Value"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function ma(){var a=la().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=ia().series(a),c=function(a){a.call(b)};return e(c,a),c}function na(b){function c(a){return"translate("+a.x+", "+a.yHigh+")"}var d=y,f=fa(),g=z().selector("g.ohlc").element("g").attr("class","ohlc"),h=function(b){b.each(function(b,e){var h=b.filter(f.defined),i=g(this,h);i.enter().attr("transform",function(a,b){return c(f.values(a,b))+" scale(1e-6, 1)"}).append("path");var j=Y().width(f.width(h));i.each(function(b,d){var e=f.values(b,d),g=a.transition(a.select(this)).attr({"class":"ohlc "+e.direction,transform:function(){return c(e)+" scale(1)"}});j.x(a.functor(0)).open(function(){return e.yOpen-e.yHigh}).high(function(){return e.yHigh-e.yHigh}).low(function(){return e.yLow-e.yHigh}).close(function(){return e.yClose-e.yHigh}),g.select("path").attr("d",j([b]))}),d(i,b,e)})};return h.decorate=function(a){return arguments.length?(d=a,h):d},a.rebind(h,g,"key"),e(h,f),h}function oa(){var b=y,c=a.scale.linear(),d=a.scale.linear(),e=function(a,b){return a.date.getDay()},f=a.scale.linear(),g=ha(),h=M(.75),i=z().selector("g.cycle").element("g").attr("class","cycle"),j=function(j){j.each(function(j,k){var l=a.nest().key(e).map(j),m=Object.keys(l),n=h(m.map(c)),o=n/2,p=i(this,m);p.each(function(b,e){var h=a.select(this);h.attr("transform","translate("+c(b)+", 0)"),(f.rangeBands||f.range)([-o,o]),g.xScale(f).yScale(d),a.select(this).datum(l[b]).call(g)}),b(p,m,k)})};return j.decorate=function(a){return arguments.length?(b=a,j):b},j.xScale=function(a){return arguments.length?(c=a,j):c},j.yScale=function(a){return arguments.length?(d=a,j):d},j.xValue=function(a){return arguments.length?(e=a,j):e},j.subScale=function(a){return arguments.length?(f=a,j):f},j.subSeries=function(a){return arguments.length?(g=a,j):g},j.barWidth=function(b){return arguments.length?(h=a.functor(b),j):h},a.rebind(j,i,"key"),j}function pa(){function b(a){return"translate("+a.x+", "+a.yHigh+")"}var c=y,d=fa(),f=z().selector("g.candlestick").element("g").attr("class","candlestick"),g=function(e){e.each(function(e,g){var h=e.filter(d.defined),i=f(this,h);i.enter().attr("transform",function(a,c){return b(d.values(a,c))+" scale(1e-6, 1)"}).append("path");var j=Z().width(d.width(h));i.each(function(c,e){var f=d.values(c,e),g=a.transition(a.select(this)).attr({"class":"candlestick "+f.direction,transform:function(){return b(f)+" scale(1)"}});j.x(a.functor(0)).open(function(){return f.yOpen-f.yHigh}).high(function(){return f.yHigh-f.yHigh}).low(function(){return f.yLow-f.yHigh}).close(function(){return f.yClose-f.yHigh}),g.select("path").attr("d",j([c]))}),c(i,e,g)})};return g.decorate=function(a){return arguments.length?(c=a,g):c},a.rebind(g,f,"key"),e(g,d),g}
...
function qa(){var b=_(),c=a.functor(0),d=y,e=a.time.scale(),f=a.scale.linear(),g=z().selector("g.axis-adapter").element("g").attr({"class":"axis axis-adapter"}),h=function(a){a.each(function(a,i){var j,k=g(this,[a]);switch(h.orient()){case"top":case"bottom":j="translate(0,"+f(c(a))+")",b.scale(e);break;case"left":case"right":j="translate("+e(c(a))+",0)",b.scale(f);break;default:throw new Error("Invalid orientation")}k.enter().attr("transform",j),k.attr("transform",j),k.call(b),d(k,a,i)})};return h.baseline=function(b){return arguments.length?(c=a.functor(b),h):c},h.decorate=function(a){return arguments.length?(d=a,h):d},h.xScale=function(a){return arguments.length?(e=a,h):e},h.yScale=function(a){return arguments.length?(f=a,h):f},a.rebind(h,b,"orient","ticks","tickValues","tickSize","innerTickSize","outerTickSize","tickPadding","tickFormat")}function ra(){var a={};return a.distance=function(a,b){return b.getTime()-a.getTime()},a.offset=function(a,b){return new Date(a.getTime()+b)},a.clampUp=w,a.clampDown=w,a.copy=function(){return a},a}
// obtains the ticks from the given scale, transforming the result to ensure
// it does not include any discontinuities
function sa(a,b,c){var d=a.map(function(d,e){if(e<a.length-1)return b.clampUp(d);var f=b.clampUp(d);return f<c[1]?f:b.clampDown(d)}),e=d.reduce(function(a,b){return 0===a.filter(function(a){return a.getTime()===b.getTime()}).length&&a.push(b),a},[]);return e}/**
	...
	*/
function ta(b,c){function d(a){var d=b.domain(),e=b.range(),f=c.distance(d[0],d[1]),g=c.distance(d[0],a),h=g/f,i=h*(e[1]-e[0])+e[0];return i}return arguments.length||(b=a.time.scale(),c=ra()),d.invert=function(a){var d=b.domain(),e=b.range(),f=(a-e[0])/(e[1]-e[0]),g=c.distance(d[0],d[1]),h=f*g;return c.offset(d[0],h)},d.domain=function(a){if(!arguments.length)return b.domain();
// clamp the upper and lower domain values to ensure they
// do not fall within a discontinuity
var e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.nice=function(){b.nice();var a=b.domain(),e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.ticks=function(){var a=b.ticks.apply(this,arguments);return sa(a,c,d.domain())},d.copy=function(){return ta(b.copy(),c.copy())},d.discontinuityProvider=function(a){return arguments.length?(c=a,d):c},a.rebind(d,b,"range","rangeRound","interpolate","clamp","tickFormat")}function ua(){return ta()}function va(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
return g=a.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function wa(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.elderRay},f=ba(),g=ba(),h=ba(),i=ba(),j=T(),k=y,l=function(a){function l(a,b){
// The values share parity and the input is smaller than the comparison
return a*b>0&&Math.abs(a)<Math.abs(b)}f.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?void 0:e(a).bullPower}),g.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?void 0:e(a).bearPower}),h.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?e(a).bullPower:void 0}),i.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?e(a).bearPower:void 0}),j.xScale(b).yScale(c).series([f,g,h,i]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["bull","bear","bull top","bear top"][b]}),k(a,b,c)}),a.call(j)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.xValue=function(a){return arguments.length?(d=a,l):d},l.yScale=function(a){return arguments.length?(c=a,l):c},l.decorate=function(a){return arguments.length?(k=a,l):k},l}function xa(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.envelope},g=y,h=la().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ha().yValue(function(a,b){return f(a).upper}),j=ha().yValue(function(a,b){return f(a).lower}),k=function(a){var d=T().xScale(b).yScale(c).series([h,i,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi envelope "+["area","upper","lower"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),a.call(d)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.xValue=function(a){return arguments.length?(e=a,k):e},k.yValue=function(a){return arguments.length?(d=a,k):d},k.root=function(a){return arguments.length?(f=a,k):f},k.decorate=function(a){return arguments.length?(g=a,k):g},k}function ya(){var b=a.time.scale(),c=a.scale.linear(),d=T(),e=y,f=S(),g=ha().yValue(function(a,b){return a.force}),h=function(a){d.xScale(b).yScale(c).series([f,g]).mapping(function(a){return a===f?[0]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["annotations","indicator"][b]}),e(a,b,c)}),a.call(d)};return h.xScale=function(a){return arguments.length?(b=a,f.xScale(a),h):b},h.yScale=function(a){return arguments.length?(c=a,f.yScale(a),h):c},h.decorate=function(a){return arguments.length?(e=a,h):e},a.rebind(h,g,"yValue","xValue"),h}function za(){var b=a.time.scale(),c=a.scale.linear(),d=80,e=20,f=T(),g=y,h=S(),i=ha().yValue(function(a,b){return a.stochastic.d}),j=ha().yValue(function(a,b){return a.stochastic.k}),k=function(a){f.xScale(b).yScale(c).series([h,i,j]).mapping(function(a){return a===h?[d,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi stochastic "+["annotations","stochastic-d","stochastic-k"][b]}),g(a,b,c)}),a.call(f)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.upperValue=function(a){return arguments.length?(d=a,k):d},k.lowerValue=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(g=a,k):g},a.rebind(k,i,"yDValue","xDValue"),a.rebind(k,j,"yKValue","xKValue"),k}function Aa(){var b=a.time.scale(),c=a.scale.linear(),d=70,e=30,f=T(),g=y,h=S(),i=ha().yValue(function(a,b){return a.rsi}),j=function(a){f.xScale(b).yScale(c).series([i,h]).mapping(function(a){return a===h?[d,50,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi rsi "+["indicator","annotations"][b]}),g(a,b,c)}),a.call(f)};return j.xScale=function(a){return arguments.length?(b=a,j):b},j.yScale=function(a){return arguments.length?(c=a,j):c},j.upperValue=function(a){return arguments.length?(d=a,j):d},j.lowerValue=function(a){return arguments.length?(e=a,j):e},j.decorate=function(a){return arguments.length?(g=a,j):g},a.rebind(j,i,"yValue","xValue"),j}function Ba(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.macd},f=ha(),g=ha(),h=ba(),i=T(),j=y,k=function(a){f.xValue(d).yValue(function(a,b){return e(a).macd}),g.xValue(d).yValue(function(a,b){return e(a).signal}),h.xValue(d).yValue(function(a,b){return e(a).divergence}),i.xScale(b).yScale(c).series([h,f,g]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["macd-divergence","macd","macd-signal"][b]}),j(a,b,c)}),a.call(i)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.xValue=function(a){return arguments.length?(d=a,k):d},k.yScale=function(a){return arguments.length?(c=a,k):c},k.root=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(j=a,k):j},k}function Ca(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.bollingerBands},g=y,h=la().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ha().yValue(function(a,b){return f(a).upper}),j=ha().yValue(function(a,b){return f(a).average}),k=ha().yValue(function(a,b){return f(a).lower}),l=function(a){var d=T().xScale(b).yScale(c).series([h,i,k,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi bollinger "+["area","upper","lower","average"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),k.xValue(e),a.call(d)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.yScale=function(a){return arguments.length?(c=a,l):c},l.xValue=function(a){return arguments.length?(e=a,l):e},l.yValue=function(a){return arguments.length?(d=a,l):d},l.root=function(a){return arguments.length?(f=a,l):f},l.decorate=function(a){return arguments.length?(g=a,l):g},l}function Da(){var a=9,b=w,c=function(c){var d,e=2/(a+1),f=0;return c.map(function(c,g){if(a-1>g)return void(f+=b(c,g));if(g===a-1){f+=b(c,g);var h=f/a;return d=h,h}var i=b(c,g)*e+(1-e)*d;return d=i,i})};return c.windowSize=function(b){return arguments.length?(a=b,c):a},c.value=function(a){return arguments.length?(b=a,c):b},c}function Ea(){var b=w,d=function(a,b){return a.high},e=function(a,b){return a.low},f=Da().windowSize(13),g=function(c){f.value(b);var g=f(c),h=a.zip(c,g).map(function(a){return{bullPower:a[1]?d(a[0])-a[1]:void 0,bearPower:a[1]?e(a[0])-a[1]:void 0}});return h};return g.value=function(a){return arguments.length?(b=a,g):b},g.highValue=function(a){return arguments.length?(d=a,g):d},g.lowValue=function(a){return arguments.length?(e=a,g):d},c(g,f,{period:"windowSize"}),g}function Fa(){var b=a.functor(void 0),c=a.functor(10),d=y,e=w,f=function(a){var f=c.apply(this,arguments),g=a.slice(0,f).map(e);return a.map(function(a,c){
...
function Ga(){var b=y,c=Fa(),d=function(d){return a.zip(d,c(d)).forEach(function(a){b(a[0],a[1])})};return d.algorithm=function(a){return arguments.length?(c=a,d):c},d.merge=function(a){return arguments.length?(b=a,d):b},d}function Ha(){var b=Ea().value(function(a){return a.close}),c=Ga().algorithm(b).merge(function(a,b){a.elderRay=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"highValue","lowValue","period","value"),d}function Ia(){var b=.1,c=w,d=function(a){return a.map(function(a){return{lower:c(a)*(1-b),upper:c(a)*(1+b)}})};return d.factor=function(a){return arguments.length?(b=a,d):b},d.value=function(b){return arguments.length?(c=a.functor(b),d):c},d}
...
function Ja(){function b(a){return Array.apply(null,new Array(a)).map(d)}var c=Fa().accumulator(a.mean),d=a.functor(void 0),e=function(a){return null==c.value()(a)},f=function(a){for(var d=0;e(a[d])&&d<a.length;)d++;var f=a.slice(d);return b(d).concat(c(f))};return f.algorithm=function(a){return arguments.length?(c=a,f):c},f.undefinedValue=function(b){return arguments.length?(d=a.functor(b),f):d},f.defined=function(a){return arguments.length?(e=a,f):e},f}function Ka(){var b=Ia(),c=Ja().undefinedValue({lower:void 0,upper:void 0}).algorithm(b),d=Ga().algorithm(c).merge(function(a,b){a.envelope=b}),e=function(a){return d(a)};return e.root=function(a){return a.envelope},a.rebind(e,d,"merge"),a.rebind(e,b,"value","factor"),e}function La(){var b=function(a,b){return a.volume},c=function(a,b){return a.close},d=Fa().windowSize(2).accumulator(function(a){return(c(a[1])-c(a[0]))*b(a[1])}),e=function(a){return d(a)};return e.volumeValue=function(a){return arguments.length?(b=a,e):b},e.closeValue=function(a){return arguments.length?(c=a,e):c},a.rebind(e,d,"windowSize"),e}function Ma(){var b=La(),c=Ga().algorithm(b).merge(function(a,b){a.force=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","volumeValue","closeValue"),d}function Na(){var b=function(a,b){return a.close},d=function(a,b){return a.high},e=function(a,b){return a.low},f=Fa().windowSize(5).accumulator(function(c){var f=a.max(c,d),g=a.min(c,e);return 100*(b(c[c.length-1])-g)/(f-g)}),g=Fa().windowSize(3).accumulator(function(b){return void 0!==b[0]?a.mean(b):void 0}),h=function(a){var b=f(a),c=g(b);return b.map(function(a,b){var d=c[b];return{k:a,d:d}})};return h.closeValue=function(a){return arguments.length?(b=a,h):b},h.highValue=function(a){return arguments.length?(d=a,h):d},h.lowValue=function(a){return arguments.length?(e=a,h):d},c(h,f,{kWindowSize:"windowSize"}),c(h,g,{dWindowSize:"windowSize"}),h}function Oa(){var b=Na(),c=Ga().algorithm(b).merge(function(a,b){a.stochastic=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"kWindowSize","dWindowSize","lowValue","closeValue","highValue"),d}function Pa(){var b,c,d,e=function(a,b){return a.close},f=function(a,b){var c=b+(a[a.length-1]-b)/a.length;return c},g=function(a,b){return a+b},h=Fa().windowSize(14).accumulator(function(a){var h=a.map(e);if(!b)return void(b=h[0]);var i=[],j=[];h.forEach(function(a){var c=b>a?b-a:0,d=a>b?a-b:0;i.push(c),j.push(d),b=a});var k=c?f(i,c):i.reduce(g)/h.length,l=d?f(j,d):j.reduce(g)/h.length;c=k,d=l;var m=l/k;return 100-100/(1+m)}),i=function(a){return h(a)};return i.closeValue=function(a){return arguments.length?(e=a,i):e},a.rebind(i,h,"windowSize"),i}function Qa(){var b=Pa(),c=Ga().algorithm(b).merge(function(a,b){a.rsi=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","closeValue"),d}function Ra(){var b=Fa().accumulator(a.mean).value(function(a){return a.close}),c=Ga().algorithm(b).merge(function(a,b){a.movingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","undefinedValue","value"),d}function Sa(){var b=w,d=Da().windowSize(12),e=Da().windowSize(29),f=Da().windowSize(9),g=Ja().algorithm(f),h=function(c){d.value(b),e.value(b);var f=a.zip(d(c),e(c)).map(function(a){return void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}),h=g(f);return a.zip(f,h).map(function(a){return{macd:a[0],signal:a[1],divergence:void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}})};return h.value=function(a){return arguments.length?(b=a,h):b},c(h,d,{fastPeriod:"windowSize"}),c(h,e,{slowPeriod:"windowSize"}),c(h,f,{signalPeriod:"windowSize"}),h}function Ta(){var b=Sa().value(function(a){return a.close}),c=Ga().algorithm(b).merge(function(a,b){a.macd=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"fastPeriod","slowPeriod","signalPeriod","value"),d}function Ua(){var b=Da().value(function(a){return a.close}),c=Ga().algorithm(b).merge(function(a,b){a.exponentialMovingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value"),d}function Va(){var b=a.functor(0),c=w,d=function(a){if(0===a.length)return[];var d=c(a[b(a)]);return a.map(function(a,b){return(c(a,b)-d)/d})};return d.baseIndex=function(c){return arguments.length?(b=a.functor(c),d):b},d.value=function(a){return arguments.length?(c=a,d):c},d}function Wa(){var b=2,c=Fa().undefinedValue({upper:void 0,average:void 0,lower:void 0}).accumulator(function(c){var d=a.mean(c),e=a.deviation(c);return{upper:d+b*e,average:d,lower:d-b*e}}),d=function(a){return c(a)};return d.multiplier=function(a){return arguments.length?(b=a,d):b},a.rebind(d,c,"windowSize","value"),d}function Xa(){var b=Wa().value(function(a){return a.close}),c=Ga().algorithm(b).merge(function(a,b){a.bollingerBands=b}),d=function(a){return c(a)};return d.root=function(a){return a.bollingerBands},a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value","multiplier"),d}function Ya(){var a=10,b=function(b){for(var c=Math.ceil(b.length/a),d=[],e=0;c>e;e++)d.push(b.slice(e*a,(e+1)*a));return d};return b.bucketSize=function(c){return arguments.length?(a=c,b):a},b}function Za(){function b(a){for(var b=a.map(function(a){return[d(a),e(a)]}),c=[],f=1;f<b.length-1;f++){var g=b[f-1],h=b[f],i=b[f+1],j=(g[0]-i[0])*(h[1]-g[1]),k=(g[0]-h[0])*(i[1]-g[1]),l=Math.abs(.5*j*k);c.push(l)}return c}var c=Ya(),d=w,e=w,f=function(d){if(c.bucketSize()>=d.length)return d;var e=b(d),f=c(e),g=c(d.slice(1,d.length-1)),h=g.map(function(b,c){var d=f[c],e=a.max(d),g=d.indexOf(e);return b[g]});
// First and last data points are their own buckets.
return[].concat(d[0],h,d[d.length-1])};return a.rebind(f,c,"bucketSize"),f.x=function(a){return arguments.length?(d=a,f):d},f.y=function(a){return arguments.length?(e=a,f):e},f}function $a(){var b=w,c=w,d=Ya(),e=function(e){if(d.bucketSize()>=e.length)return e;var f=d(e.slice(1,e.length-1)),g=e[0],h=e[e.length-1],i=[].concat(g,f,h),j=b(g),k=c(g),l=f.map(function(d,e){for(var f,g=-(1/0),h=a.mean(i[e+1],b),l=a.mean(i[e+1],c),m=0;m<d.length;m++){var n=b(d[m]),o=c(d[m]),p=(j-h)*(o-k),q=(j-n)*(l-k),r=Math.abs(.5*p*q);r>g&&(g=r,f=d[m])}return j=b(f),k=c(f),f});
// First and last data points are their own buckets.
return[].concat(e[0],l,e[e.length-1])};return a.rebind(e,d,"bucketSize"),e.x=function(a){return arguments.length?(b=a,e):b},e.y=function(a){return arguments.length?(c=a,e):c},e}function _a(){var b=Ya(),c=w,d=function(d){if(b.bucketSize()>d.length)return d;var e=a.extent(d),f=b(d.slice(1,d.length-1)),g=f.map(function(a,b){for(var d,f,g={},h=!0,i=0;i<a.length;i++){var j=c(a[i]);if(j===e[0]||j===e[1])return a[i];void 0===g[j]&&(g[j]=0),g[j]++,g[j]>g[d]||void 0===d?(d=j,f=i,h=!0):g[j]===g[d]&&(h=!1)}return h?a[f]:a[Math.floor(a.length/2)]});
// First and last data points are their own buckets.
...
// by default.
return Number(a[b])},f=function(c){return"vertical"===d?a(c):b(c)};return f.xValueKey=function(a){return arguments.length?(c=a,f):c},f.yValue=function(a){return arguments.length?(e=a,f):e},f.orient=function(a){return arguments.length?(d=a,f):d},f}function bb(){var b=1,c=20,d=.1,e=.1,f=function(f){var g,h,i=a.random.normal(),j=b/c,k=new Array(c+1);
...
function fb(){var b="BTC-USD",c=null,d=null,e=null,f=function(f){var g=[];null!=c&&g.push("start="+c.toISOString()),null!=d&&g.push("end="+d.toISOString()),null!=e&&g.push("granularity="+e);var h="https://api.exchange.coinbase.com/products/"+b+"/candles?"+g.join("&");a.json(h,function(a,b){return a?void f(a):(b=b.map(function(a){return{date:new Date(1e3*a[0]),open:a[3],high:a[2],low:a[1],close:a[4],volume:a[5]}}),void f(a,b))})};return f.product=function(a){return arguments.length?(b=a,f):b},f.start=function(a){return arguments.length?(c=a,f):c},f.end=function(a){return arguments.length?(d=a,f):d},f.granularity=function(a){return arguments.length?(e=a,f):e},f}function gb(b,c){function d(a){return z().selector("g."+a).element("g").attr("class",a)}b=b||a.scale.linear(),c=c||a.scale.linear();var f=10,g=9,h=y,i=ha(),j={bottom:30,right:30},k=function(a){return a.values},l=function(a){return a.key},m=_().ticks(2),n=_().orient("right").ticks(3),o=d("multiple"),p=d("x-axis"),q=d("y-axis"),r=function(d){d.each(function(d,e){function r(a,b){return{xOffset:(x+f)*a,yOffset:(y+f)*b}}var s=a.select(this),t=O(j);t.position="absolute";var u=s.selectAll("svg").data([d]);u.enter().append("svg").layout("flex",1).append("g").attr("class","multiples-chart");var v=u.select("g").layout(t);s.layout();var w=Math.ceil(d.length/g),x=v.layout("width")/g-f,y=v.layout("height")/w-f;C(b,[0,x]),C(c,[y,0]),i.xScale(b).yScale(c);
// create a container for each multiple chart
var z=o(v,d);z.attr("transform",function(a,b){var c=r(b%g,Math.floor(b/g));return"translate("+c.xOffset+","+c.yOffset+")"});
...
z.select("g").datum(k).call(i),z.select("rect").attr({width:x,height:y}),h(z,d,e);var B=p(v,a.range(g));B.attr("transform",function(a,b){var c="bottom"===m.orient()?w:0,d="bottom"===m.orient()?0:-f,e=r(b,c);return"translate("+e.xOffset+","+(e.yOffset+d)+")"}),m.scale(b),B.call(m);var D=q(v,a.range(w));D.attr("transform",function(a,b){var c="left"===n.orient()?0:g,d="left"===n.orient()?-f:0,e=r(c,b);return"translate("+(e.xOffset+d)+","+e.yOffset+")"}),n.scale(c),D.call(n)})},s=[/range\w*/,// the scale range is set via the component layout
/tickFormat/];return e(r,b,"x",s),e(r,c,"y",s),e(r,m,"x"),e(r,n,"y"),r.columns=function(a){return arguments.length?(g=a,r):g},r.margin=function(a){return arguments.length?(j=a,r):j},r.padding=function(a){return arguments.length?(f=a,r):f},r.plotArea=function(a){return arguments.length?(i=a,r):i},r.values=function(a){return arguments.length?(k=a,r):k},r.key=function(a){return arguments.length?(l=a,r):l},r.decorate=function(a){return arguments.length?(h=a,r):h},r}function hb(){var b=50,c=y,d=[["datum:",function(a){return a.datum}]],e=z().selector("g.cell").element("g").attr("class","cell tooltip"),f=function(f){f.each(function(f,g){var h=a.select(this),i=d.map(function(b,c){return{datum:f,label:a.functor(b[0]),value:a.functor(b[1])}}),j=e(h,i);j.enter().layout({flex:1,flexDirection:"row"}),j.enter().append("text").attr("class","label").layout("flex",b),j.enter().append("text").attr("class","value").layout("flex",100-b),j.select(".label").text(function(a,b){return a.label.call(this,a.datum,b)}),j.select(".value").text(function(a,b){return a.value.call(this,a.datum,b)}),c(j,f,g),h.layout()})};return f.decorate=function(a){return arguments.length?(c=a,f):c},f.split=function(a){return arguments.length?(b=a,f):b},f.items=function(a){return arguments.length?(d=a,f):d},f}function ib(){
// creates an array with four elements, representing the high, low, open and close
// values of the given array
function b(b){function c(a){return b.filter(function(b){return e(b)===a})[0]}var d=j.xValue(),e=j.yValue(),f=a.max(b,e),g=a.min(b,e);return[{x:d(b[0]),y:e(b[0])},{x:d(c(f)),y:f},{x:d(c(g)),y:g},{x:d(b[b.length-1]),y:e(b[b.length-1])}]}var d=ua(),e=a.scale.linear(),f=2,g=ha(),h=V().xValue(function(a){return a.x}).yValue(function(a){return a.y}).decorate(function(a){a.attr("class",function(a,b){switch(b){case 0:return"open";case 1:return"high";case 2:return"low";case 3:return"close"}})}),i=T().series([g,h]).mapping(function(a){switch(a){case h:return b(this);default:return this}}),j=function(b){h.size(f*f*Math.PI),b.each(function(b){var c=a.select(this),g=L(this),h=f;d.range([h,g.width-h]),e.range([g.height-h,h]),i.xScale(d).yScale(e),c.call(i)})};return c(j,d,{xDiscontinuityProvider:"discontinuityProvider",xDomain:"domain"}),c(j,e,{yDomain:"domain"}),c(j,g,"xValue","yValue"),j.xScale=function(){return d},j.yScale=function(){return e},j.radius=function(a){return arguments.length?(f=a,j):f},j}function jb(b,c){b=b||a.scale.linear(),c=c||a.scale.linear();var d={bottom:30,right:30},f="",g="",h=null,i=null,j="",k=ha(),l=y,m=qa().orient("bottom").baseline(function(){if(null!==h)return c(h.apply(this,arguments));var a=B(c);return"bottom"===m.orient()?a[0]:a[1]}),n=qa().orient("right").baseline(function(){if(null!==i)return b(i.apply(this,arguments));var a=B(b);return"left"===n.orient()?a[0]:a[1]}),o=z().selector("svg.cartesian-chart").element("svg").attr({"class":"cartesian-chart","layout-style":"flex: 1"}),p=function(e){e.each(function(e,h){var i=a.select(this),p=o(i,[e]);p.enter().html('<g class="plot-area-container">                     <rect class="background"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                     <g class="axes-container"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0">                         <g class="x-axis" layout-style="height: 0; width: 0"/>                         <g class="y-axis" layout-style="height: 0; width: 0"/>                     </g>                     <svg class="plot-area"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                 </g>                 <g class="x-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="y-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="title label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>');var q=O(d);p.select(".plot-area-container").layout({position:"absolute",top:q.top,left:q.left,bottom:q.bottom,right:q.right}),p.select(".title").layout({position:"absolute",top:0,alignItems:"center",left:q.left,right:q.right});var r={position:"absolute",top:q.top,bottom:q.bottom,alignItems:"center",flexDirection:"row"};r[n.orient()]=0,p.select(".y-axis.label-container").attr("class","y-axis label-container "+n.orient()).layout(r);var s={position:"absolute",left:q.left,right:q.right,alignItems:"center"};s[m.orient()]=0,p.select(".x-axis.label-container").attr("class","x-axis label-container "+m.orient()).layout(s),
// perform the flexbox / css layout
i.layout(),
// update the label text
p.select(".title .label").text(j),p.select(".y-axis.label-container .label").text(f).attr("transform","right"===n.orient()?"rotate(90)":"rotate(-90)"),p.select(".x-axis.label-container .label").text(g);
// set the axis ranges
var t=p.select(".plot-area");C(b,[0,t.layout("width")]),C(c,[t.layout("height"),0]),
// render the axes
...
k.xScale(b).yScale(c),t.call(k),l(p,e,h)})},q=[/range\w*/,// the scale range is set via the component layout
/tickFormat/];e(p,b,"x",q),e(p,c,"y",q);var r=["baseline",// the axis baseline is adapted so is not exposed directly
"xScale","yScale"];return e(p,m,"x",r),e(p,n,"y",r),p.xBaseline=function(b){return arguments.length?(h=a.functor(b),p):h},p.yBaseline=function(b){return arguments.length?(i=a.functor(b),p):i},p.chartLabel=function(a){return arguments.length?(j=a,p):j},p.plotArea=function(a){return arguments.length?(k=a,p):k},p.xLabel=function(a){return arguments.length?(g=a,p):g},p.margin=function(a){return arguments.length?(d=a,p):d},p.yLabel=function(a){return arguments.length?(f=a,p):f},p.decorate=function(a){return arguments.length?(l=a,p):l},p}function kb(){var b=a.time.scale(),d=a.scale.linear(),e=10,f=10,g=y,h=y,i=z().selector("line.x").element("line").attr("class","x gridline"),j=z().selector("line.y").element("line").attr("class","y gridline"),k=function(a){a.each(function(a,c){var k=b.ticks(e),l=i(this,k);l.attr({x1:b,x2:b,y1:d.range()[0],y2:d.range()[1]}),g(l,k,c);var m=d.ticks(f),n=j(this,m);n.attr({x1:b.range()[0],x2:b.range()[1],y1:d,y2:d}),h(n,m,c)})};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(d=a,k):d},k.xTicks=function(a){return arguments.length?(e=a,k):e},k.yTicks=function(a){return arguments.length?(f=a,k):f},k.yDecorate=function(a){return arguments.length?(h=a,k):h},k.xDecorate=function(a){return arguments.length?(g=a,k):g},c(k,i,{xKey:"key"}),c(k,j,{yKey:"key"}),k}function lb(){var b,c,d,e,f=a.time.scale(),g=a.scale.linear(),h=function(){return B(f)[0]},i=function(){return B(f)[1]},j=function(){return B(g)[0]},k=function(){return B(g)[1]},l=y,m=z().selector("g.annotation").element("g").attr("class","annotation"),n=function(b){b.each(function(b,c){var d=a.select(this),e=m(d,b);e.enter().append("path").classed("band",!0);var f=$().horizontalAlign("right").verticalAlign("top").x(h).y(j).height(function(){return k.apply(this,arguments)-j.apply(this,arguments)}).width(function(){return i.apply(this,arguments)-h.apply(this,arguments)});e.select("path").attr("d",function(a,b){
// the path generator is being used to render a single path, hence
// an explicit index is provided
return f.call(this,[a],b)}),l(e,b,c)})};return n.xScale=function(a){return arguments.length?(f=a,n):f},n.yScale=function(a){return arguments.length?(g=a,n):g},n.decorate=function(a){return arguments.length?(l=a,n):l},n.x0=function(c){return arguments.length?(b=a.functor(c),h=function(){return f(b.apply(this,arguments))},n):b},n.x1=function(b){return arguments.length?(c=a.functor(b),i=function(){return f(c.apply(this,arguments))},n):c},n.y0=function(b){return arguments.length?(d=a.functor(b),j=function(){return g(d.apply(this,arguments))},n):d},n.y1=function(b){return arguments.length?(e=a.functor(b),k=function(){return g(e.apply(this,arguments))},n):e},n}function mb(a){for(;a.ownerSVGElement;)a=a.ownerSVGElement;return a}
// parses the style attribute, converting it into a JavaScript object
function nb(a){if(!a)return{};var b=a.split(";"),c={};return b.forEach(function(a){var b=a.split(":");if(2===b.length){var d=b[0].trim(),e=b[1].trim();c[d]=isNaN(e)?e:Number(e)}}),c}
// creates the structure required by the layout engine
function ob(a){function b(){for(var b=[],c=0;c<a.childNodes.length;c++){var d=a.childNodes[c];1===d.nodeType&&d.getAttribute("layout-style")&&b.push(ob(d))}return b}return{style:nb(a.getAttribute("layout-style")),children:b(a),element:a}}
...
!c&&b&&a.element.setAttribute("transform","translate("+a.layout.left+", "+a.layout.top+")"),a.children.forEach(function(a){pb(a,!0)})}function qb(a){return a.hasAttribute("layout-width")&&a.hasAttribute("layout-height")?{width:Number(a.getAttribute("layout-width")),height:Number(a.getAttribute("layout-height"))}:L(a)}function rb(a){return a.hasAttribute("layout-x")&&a.hasAttribute("layout-y")?{x:Number(a.getAttribute("layout-x")),y:Number(a.getAttribute("layout-y"))}:{x:0,y:0}}function sb(a){if("suspended"!==mb(a).__layout__){var b=qb(a),c=rb(a),d=ob(a);
...
pb(d)}}function tb(a){return arguments.length?this.each(function(){mb(this).__layout__=a?"suspended":""}):Boolean(mb(this.node()).__layout__)}function ub(a,b){var c=arguments.length;
...
this.setAttribute("layout-width",a),this.setAttribute("layout-height",b),sb(this)):
...
var d=nb(this.getAttribute("layout-style")),e=a;Object.keys(e).forEach(function(a){d[a]=e[a]});var f=Object.keys(d).map(function(a){return a+":"+d[a]}).join(";");this.setAttribute("layout-style",f)}}else 0===c&&
// layout() - executes layout
sb(this)})}function vb(){return++cd}function wb(a,b){function c(b){return a.secondaries.filter(function(a,c){return c===b})}for(var d=0,e=0;e<b.secondaries.length;e++)b.secondaries[e]&&d++;a.secondaries.filter(function(a,b){return d>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=d}).style("flex","0"),a.overlaySecondaries.filter(function(a,b){return d>b}).style("flex","1"),a.overlaySecondaries.filter(function(a,b){return b>=d}).style("flex","0");var f=parseInt(a.app.select(".head-row").style("height"),10);dd||(f+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),dd=!0);var g=bd.util.innerDimensions(a.app.node()).height-f;a.chartsAndOverlay.style("height",g+"px"),b.xAxis.dimensionChanged(a.xAxis),b.navbar.dimensionChanged(a.navbar),b.primary.dimensionChanged(a.primary);for(var h=0;h<b.secondaries.length;h++)b.secondaries[h].option.dimensionChanged(c(h))}function xb(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function yb(b,c,d){arguments.length<3&&(d=1);var e=bd.util.extent().fields("date")(c),f=(e[1].getTime()-e[0].getTime())/1e3,g=b.map(function(a){return a.getTime()}),h=d*(a.max(g)-a.min(g))/1e3,i=f>h?[a.time.second.offset(e[1],-h),e[1]]:e;return i}function zb(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}function Ab(b,c,d){var e=bd.util.extent().fields("date")(c),f=b.map(function(a){return a.getTime()}),g=(a.max(f)-a.min(f))/1e3;if(d.getTime()<e[0]||d.getTime()>e[1])return[new Date(a.min(f)),new Date(a.max(f))];var h=[a.time.second.offset(d,-g/2),a.time.second.offset(d,g/2)],i=0;return h[1].getTime()>e[1].getTime()?i=(e[1].getTime()-h[1].getTime())/1e3:h[0].getTime()<e[0].getTime()&&(i=(e[0].getTime()-h[0].getTime())/1e3),[a.time.second.offset(h[0],i),a.time.second.offset(h[1],i)]}function Bb(b){function c(a){
// Don't pan off sides
// Don't pan off sides
return a[0]>=0?-a[0]:a[1]<=0?-a[1]:0}function d(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function e(a){var b=j.translate()[0];b+=a,j.translate([b,0])}function f(){j.translate([0,0]),j.scale(1)}function g(a){var g=bd.util.extent().fields("date")(a.datum().data);j.x(h).on("zoom",function(){var n=h(g[0]),o=h(g[1]),p=d([n,o-b]),q=c([n,o-b]);e(q);var r=1===j.scale(),s=1!==j.scale();if(r&&k||s&&l){var t=h.domain();p?t=g:s&&m&&(t=fd.domain.moveToLatest(t,a.datum().data)),t[0].getTime()!==t[1].getTime()?i.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
f()}else f()}),a.call(j)}var h,i=a.dispatch("zoom"),j=a.behavior.zoom(),k=!0,l=!0,m=!0;return g.allowPan=function(a){return arguments.length?(k=a,g):k},g.allowZoom=function(a){return arguments.length?(l=a,g):l},g.trackingLatest=function(a){return arguments.length?(m=a,g):m},g.scale=function(a){return arguments.length?(h=a,g):h},a.rebind(g,i,"on"),g}function Cb(){function b(b){b.each(function(f){var h=a.select(this).call(j),i=Bb(c).scale(e).trackingLatest(g).on("zoom",function(a){d[gd.viewChange](a)});h.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var c,d=a.dispatch(gd.viewChange),e=bd.scale.dateTime(),f=a.scale.linear(),g=!0,h=60,i=bd.series.multi(),j=bd.chart.cartesian(e,f).plotArea(i).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:h});return b.trackingLatest=function(a){return arguments.length?(g=a,b):g},a.rebind(b,d,"on"),a.rebind(b,i,"series","mapping","decorate"),a.rebind(b,j,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),b.dimensionChanged=function(a){c=parseInt(a.style("width"),10)-h},b}function Db(){function b(a){a.each(function(b){var c=bd.util.extent().fields("volume").pad(.08)(b.data);c[0]<0&&(c[0]=0),e.yTickFormat(b.product.volumeFormat).trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(e)})}var c=a.dispatch(gd.viewChange),d=bd.series.bar().yValue(function(a){return a.volume}),e=Cb().series([d]).yTicks(4).on(gd.viewChange,function(a){c[gd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){e.dimensionChanged(a)},b}function Eb(){function b(a){var b=a.datum();e(b.data),g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b.data).call(g)}var c=a.dispatch(gd.viewChange),d=bd.indicator.renderer.relativeStrengthIndex(),e=bd.indicator.algorithm.relativeStrengthIndex(),f=[d.lowerValue(),50,d.upperValue()],g=Cb().series([d]).yTickValues(f).on(gd.viewChange,function(a){c[gd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Fb(){function b(a){var b=a.datum();f(b.data);var c=bd.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(b.data.map(function(a){return a.macd}));g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(g)}var c=a.dispatch(gd.viewChange),d=bd.annotation.line().value(0).label(""),e=bd.indicator.renderer.macd(),f=bd.indicator.algorithm.macd(),g=Cb().series([d,e]).yTicks(5).mapping(function(a){return a===d?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(gd.viewChange,function(a){c[gd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Gb(){function b(a){var b=(d.ticks()[1]-d.ticks()[0])/1e3;b<a.seconds?e.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):e.ticks(6)}function c(a){var c=a.datum();d.domain(c.viewDomain),b(c.period),a.call(e)}var d=bd.scale.dateTime(),e=a.svg.axis().scale(d).orient("bottom");return c.dimensionChanged=function(a){d.range([0,parseInt(a.style("width"),10)])},c}function Hb(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function Ib(){var b=bd.scale.dateTime(),c=a.scale.linear(),d=bd.util.fractionalBarWidth(.75),e=function(a,b){return a.date},f=function(a,c){return b(e(a,c))},g=function(a){return a.low},h=function(a){return a.high},i=function(a,b){return a.close},j=bd.svg.candlestick().x(function(a){return b(a.date)}).open(function(a){return c(a.open)}).high(function(a){return c(h(a))}).low(function(a){return c(g(a))}).close(function(a){return c(a.close)}),k=bd.util.dataJoin().selector("path.up").element("path").attr("class","up"),l=bd.util.dataJoin().selector("path.down").element("path").attr("class","down"),m=function(a){a.each(function(a){j.width(d(a.map(f)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});k(this,[b]).attr("d",j),l(this,[c]).attr("d",j)})};return m.xScale=function(a){return arguments.length?(b=a,m):b},m.yScale=function(a){return arguments.length?(c=a,m):c},m.xValue=function(a){return arguments.length?(e=a,m):e},m.yLowValue=function(a){return arguments.length?(g=a,m):g},m.yHighValue=function(a){return arguments.length?(h=a,m):h},m.yCloseValue=function(a){return arguments.length?(i=a,m):i},m.width=function(a){return d(a.map(f))},m}function Jb(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function Kb(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function Lb(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function Mb(){function b(){var a=[q,i.option,r],b=n.map(function(a){return a.option});return a.concat(b,p)}function c(){switch(w.value(m),x.value(m),r.value(m),i.valueString){case"line":case"point":case"area":i.option.yValue(m)}}
// Call when what to display on the chart is modified (ie series, options)
function d(a){i=a.series,m=a.yValueAccessor.option,n=a.indicators,c(),s.series(b()),v.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function e(a){var b=i.option.width(a);p.decorate(function(a){a.classed("band hidden-xs hidden-sm",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function f(a){a.classed("band",!1).classed("hidden-xs hidden-sm",!0).selectAll("line").style("stroke-width",null)}function g(a){"candlestick"===i.valueString||"ohlc"===i.valueString?e(a):p.decorate(f)}function h(b){var c=b.datum();c.selectorsChanged&&d(c),v.xDomain(c.viewDomain),p.snap(bd.util.seriesPointSnapXOnly(i.option,c.data)),g(c.data),w(c.data),x(c.data);
// Scale y axis
var e=fd.domain.filterDataInDateRange(v.xDomain(),c.data),f=Lb(s.series()),h=bd.util.extent().fields(f).pad(.08)(e);v.yDomain(h);
// Find current tick values and add close price to this list, then set it explicitly below
var n=m(c.data[c.data.length-1]),o=Kb(u,[n]);v.yTickValues(o).yDecorate(function(b){var c=b.selectAll(".tick").filter(function(a){return a===n}).classed("closeLine",!0),d=18;c.select("path").attr("d",function(b){return a.svg.area()(Jb(k,d))}),c.select("text").attr("transform","translate("+d/2+",1)")}),
// Redraw
v.plotArea(s),b.call(v);var q=Bb(j).scale(t).trackingLatest(c.trackingLatest).on("zoom",function(a){l[gd.viewChange](a)});b.select(".plot-area").call(q)}var i,j,k=60,l=a.dispatch(gd.viewChange,gd.crosshairChange),m=function(a){return a.close},n=[],o=[],p=bd.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?l.crosshairChange(a[0].datum):l.crosshairChange(void 0)}).on("trackingend",function(){l.crosshairChange(void 0)});p.id=fd.uid();var q=bd.annotation.gridline().yTicks(5).xTicks(0),r=bd.annotation.line().orient("horizontal").value(m).label("");r.id=fd.uid();var s=bd.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case r:return[this.data[this.data.length-1]];case p:return o;default:return this.data}}),t=bd.scale.dateTime(),u=a.scale.linear(),v=bd.chart.cartesian(t,u).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:k}),w=bd.indicator.algorithm.movingAverage(),x=bd.indicator.algorithm.bollingerBands();
...
function Nb(a){return jd(a).width()}function Ob(){function b(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function c(a){return a.extent()[0][0]-a.extent()[1][0]===0}function d(a,b){var c=a.selectAll("defs").data([0]).enter().append("defs");c.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:f,height:i}),w.domain(bd.util.extent().fields("date")(b)),x.domain(bd.util.extent().fields(["low","high"])(b)),a.select("mask").datum(b).call(y)}function e(a){var e=a.datum();d(a,e.data),r.domain(e.viewDomain);var g=fd.domain.filterDataInDateRange(bd.util.extent().fields("date")(e.data),e.data),h=bd.util.extent().fields(["low","high"])(g);q.xDomain(bd.util.extent().fields("date")(e.data)).yDomain(h),u.on("brush",function(){var d=c(u);
// Hide the bar if the extent is empty
b(a,d),d||p[gd.viewChange]([u.extent()[0][0],u.extent()[1][0]])}).on("brushend",function(){var d=c(u);b(a,!1),d&&p[gd.viewChange](fd.domain.centerOnDate(r.domain(),e.data,u.extent()[0][0]))}),q.plotArea(v),a.call(q);
// Allow to zoom using mouse, but disable panning
var i=Bb(f).scale(r).trackingLatest(e.trackingLatest).allowPan(!1).on("zoom",function(a){p[gd.viewChange](a)});a.select(".plot-area").call(i)}var f,g=100,h=40,i=g-h,j=2,k=j/2,l=i-k,m=l,n=k+m/2,o=2,p=a.dispatch(gd.viewChange),q=bd.chart.cartesian(bd.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:h}),r=bd.scale.dateTime(),s=bd.series.area().yValue(function(a){return a.close}),t=bd.series.line().yValue(function(a){return a.close}),u=a.svg.brush(),v=bd.series.multi().series([s,t,u]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",l).attr("y",j/2),
// overload d3 styling for the brush handles
// as Firefox does not react properly to setting these through less file.
b.selectAll(".resize.w>rect, .resize.e>rect").attr("width",o).attr("x",-o/2),a.selectAll(".resize.w>rect, .resize.e>rect").attr("height",m).attr("y",k),b.select(".extent").attr("mask",'url("#brush-mask")').attr("fill",'url("#brush-gradient")');
// Adds the handles to the brush sides
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",n).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",n).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==u?this.data:void u.extent([[r.domain()[0],q.yDomain()[0]],[r.domain()[1],q.yDomain()[1]]])}),w=bd.scale.dateTime(),x=a.scale.linear(),y=bd.series.area().yValue(function(a){return a.close}).xScale(w).yScale(x);return a.rebind(e,p,"on"),e.dimensionChanged=function(a){f=Nb(a.node()),r.range([0,f]),w.range([0,f]),x.range([i,0])},e}function Pb(){function b(b){b.each(function(b){var h=a.select(this);if(c=b.product.priceFormat,d=b.product.volumeFormat,e=b.period.timeFormat,null==b.data||b.data!==f){f=b.data;var i=h.selectAll("span").data(g);i.enter().append("span").attr("class",function(a,b){return b%2===0?"legendLabel":"legendValue"}),i.text(function(a,c){var d="";return c%2===0?a:b.data?a(b.data):d})}})}var c,d,e,f,g=["T",function(a){return e(a.date)},"O",function(a){return c(a.open)},"H",function(a){return c(a.high)},"L",function(a){return c(a.low)},"C",function(a){return c(a.close)},"V",function(a){return d(a.volume)}];return b}function Qb(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon sc-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(gd.indicatorChange);return a.rebind(b,c,"on"),b}function Rb(){var b=a.dispatch(gd.primaryChartIndicatorChange,gd.secondaryChartChange),c=Qb().on(gd.indicatorChange,b[gd.primaryChartIndicatorChange]),d=Qb().on(gd.indicatorChange,b[gd.secondaryChartChange]),e=function(b){b.each(function(b){var e=a.select(this);e.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),e.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(e,b,"on"),e}function Sb(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[gd.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(gd.resetToLatest);return a.rebind(b,c,"on"),b}function Tb(){function b(a){var b=a.datum(),h=b.selectedIndex||0,i=b.config,j=d(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[h].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[h].displayString});e(j,i.careted?[0]:[]);var l=f(a,[b.options]),m=g(l,b.options),n=m.enter().on("click",c.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var c=a.dispatch("optionChange"),d=bd.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),e=bd.util.dataJoin().selector(".caret").element("span").attr("class","caret"),f=bd.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),g=bd.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(b,c,"on"),b}function Ub(){var b=a.dispatch(gd.primaryChartSeriesChange,gd.primaryChartIndicatorChange,gd.secondaryChartChange),c=Tb().on("optionChange",b[gd.primaryChartSeriesChange]),d=Tb().on("optionChange",function(a){a.isPrimary?b[gd.primaryChartIndicatorChange](a):b[gd.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select("#series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select("#indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}
// Generates a menu option similar to those generated by sc.model.menu.option from a sc.model.data.product object
function Vb(a){return{displayString:a.display,option:a}}
// Generates a menu option similar to those generated by model.menu.option from a model.data.period object
function Wb(a){return{displayString:a.display,option:a}}function Xb(){function b(a){var b=a.datum().selectedIndex||0,e=d(a,[a.datum().options]);e.enter().append("ul");var f=e.selectAll("li").data(bd.util.fn.identity);f.enter().append("li").append("a").attr("href","#").on("click",c.tabClick),f.classed("active",function(a,c){return c===b}).select("a").text(function(a){return a.displayString}),f.exit().remove()}var c=a.dispatch("tabClick"),d=bd.util.dataJoin().selector("ul").element("ul");return a.rebind(b,c,"on"),b}function Yb(){var b=a.dispatch(gd.dataProductChange,gd.dataPeriodChange,gd.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=Tb().on("optionChange",b[gd.dataProductChange]),d=Xb().on("tabClick",b[gd.dataPeriodChange]),e=Tb().on("optionChange",b[gd.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(Vb),selectedIndex:h.map(function(a){return a.id}).indexOf(f.selectedProduct.id)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(Wb),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(Wb),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[gd.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f}function Zb(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function $b(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function _b(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(k,a),g[gd.newTrade](k,f)}).on("error",function(a){g[gd.streamingFeedError](a,f)}).on("close",function(a){g[gd.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var l=new Date;f.historicFeed.end(l).candles(j).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[gd.historicFeedError](a,f):(k=c(b),g[gd.historicDataLoaded](k,f),d())}))}var f,g=a.dispatch(gd.newTrade,gd.historicDataLoaded,gd.historicFeedError,gd.streamingFeedError,gd.streamingFeedClose),h=$b().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=Zb(),j=200,k=[];return a.rebind(e,g,"on"),e}function ac(){var b=a.dispatch(gd.notificationClose),c=bd.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),d=bd.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),e=function(e){e.each(function(e){var f=a.select(this),g=c(f,[e]);g.enter().html('<div class="messages"></div>');var h=d(g.select(".messages"),e.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){b[gd.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(e,b,"on"),e}function bc(a){return{id:fd.uid(),message:a}}function cc(a,b,c,d){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d}}function dc(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}}function ec(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}}function fc(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b}function gc(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=fc(a)),b}function hc(){return{messages:[]}}function ic(a){return{viewDomain:[],period:a}}function jc(a){return{data:[],viewDomain:[],trackingLatest:!0,product:a}}function kc(a){var b={data:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0},c=a;Object.defineProperty(b,"product",{get:function(){return c},set:function(a){c=a,b.selectorsChanged=!0}});var d=Ib();d.id=fd.uid();var e=Hb("Candlestick","candlestick",d);e.option.extentAccessor=["high","low"],Object.defineProperty(b,"series",{get:function(){return e},set:function(a){e=a,b.selectorsChanged=!0}});var f={option:function(a){return a.close}};Object.defineProperty(b,"yValueAccessor",{get:function(){return f},set:function(a){f=a,b.selectorsChanged=!0}});var g=[];return Object.defineProperty(b,"indicators",{get:function(){return g},set:function(a){g=a,b.selectorsChanged=!0}}),b}function lc(){return{trackingLatest:!0}}function mc(){return{data:[],viewDomain:[],trackingLatest:!0}}function nc(a,b){return{data:void 0,product:a,period:b}}function oc(a,b){return{config:a,options:b}}function pc(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}}function qc(){return{primaryIndicators:[],secondaryIndicators:[]}}function rc(a,b,c){return{productConfig:pc(null,!0),mobilePeriodConfig:pc(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[]}}function sc(){var a,b,c,d=bd.data.random.financial(),e=[86400],f=null,g=function(c){b.setHours(0,0,0,0);var e=864e5;d.startDate(new Date(b-(a-1)*e));var f=d(a);c(null,f)};return g.candles=function(b){return arguments.length?(a=b,g):a},g.end=function(a){return arguments.length?(b=a,g):b},g.granularity=function(a){if(!arguments.length)return c;if(-1===e.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return c=a,g},g.product=function(a){if(!arguments.length)return g;if(null!==a)throw new Error("Random Financial Data Generator does not support products.");return f=a,g},g.apiKey=function(){throw new Error("Not implemented.")},g}
// Inspired by underscore library implementation of debounce
function tc(a,b,c){var d,e,f,g,h=function(){var i=(new Date).getTime()-f;b>i&&i>=0?d=setTimeout(h.bind(this),b-i):(d=null,c||(g=a.apply(this,e),e=null))};return function(){e=arguments,f=(new Date).getTime();var i=c&&!d;return d||(d=setTimeout(h.bind(this),b)),i&&(g=a.apply(this,e),e=null),g}}function uc(){var b,c=1e3,d=bd.data.feed.coinbase(),e=tc(function(c){var e=a.time.second.offset(d.end(),-b*d.granularity());d.start(e),d(c)},c);return e.candles=function(a){return arguments.length?(b=a,e):b},e.apiKey=function(){throw new Error("Not implemented.")},a.rebind(e,d,"end","granularity","product"),e}function vc(a){var b;return a&&(b=a.message),b}
// https://docs.exchange.coinbase.com/#websocket-feed
function wc(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.exchange.coinbase.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){
// Only close the WebSocket if it is opening or open
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function xc(){function b(b){var g=a.time.second.offset(e.end(),-d*c);e.start(g).collapse(f.get(c)),e(b)}var c,d,e=bd.data.feed.quandl(),f=a.map();return f.set(86400,"daily"),f.set(604800,"weekly"),b.candles=function(a){return arguments.length?(d=a,b):d},b.granularity=function(a){if(!arguments.length)return c;if(!f.has(a))throw new Error("Granularity of "+a+" is not supported.");return c=a,b},bd.util.rebind(b,e,{end:"end",product:"dataset",apiKey:"apiKey"}),b}function yc(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function zc(){function b(){return{week1:rd.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:rd.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:rd.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:rd.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:rd.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function c(){return{generated:rd.data.source(sc(),null,null),bitcoin:rd.data.source(uc(),vc,wc(),gc),quandl:rd.data.source(xc(),yc,null,null)}}function d(){return{generated:rd.data.product(null,"Data Generator",[i.day1],j.generated,".3s"),quandl:rd.data.product("GOOG","GOOG",[i.day1,i.week1],j.quandl,".3s")}}function e(){var a=Ib();a.id=fd.uid();var b=rd.menu.option("Candlestick","candlestick",a,"sc-icon-candlestick-series");b.isSelected=!0,b.option.extentAccessor=["high","low"];var c=bd.series.ohlc();c.id=fd.uid();var d=rd.menu.option("OHLC","ohlc",c,"sc-icon-ohlc-series");d.option.extentAccessor=["high","low"];var e=bd.series.line();e.id=fd.uid();var f=rd.menu.option("Line","line",e,"sc-icon-line-series");f.option.extentAccessor="close";var g=bd.series.point();g.id=fd.uid();var h=rd.menu.option("Point","point",g,"sc-icon-point-series");h.option.extentAccessor="close";var i=bd.series.area();i.id=fd.uid();var j=rd.menu.option("Area","area",i,"sc-icon-area-series");j.option.extentAccessor="close";var k=rd.menu.dropdownConfig(null,!1,!0,!0),l=[b,d,f,h,j];return rd.menu.selector(k,l)}function f(){var a=kd.secondary,b=bd.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).yValue(function(a){return a.movingAverage});b.id=fd.uid();var c=rd.menu.option("Moving Average","movingAverage",b,"sc-icon-moving-average-indicator",!0);c.option.extentAccessor=function(a){return a.movingAverage};var d=bd.indicator.renderer.bollingerBands();d.id=fd.uid();var e=rd.menu.option("Bollinger Bands","bollinger",d,"sc-icon-bollinger-bands-indicator",!0);e.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var f=[c,e,rd.menu.option("Relative Strength Index","secondary-rsi",a.rsi(),"sc-icon-rsi-indicator",!1),rd.menu.option("MACD","secondary-macd",a.macd(),"sc-icon-macd-indicator",!1),rd.menu.option("Volume","secondary-volume",a.volume(),"sc-icon-bar-series",!1)];return f}function g(){var a=rd.menu.dropdownConfig("Add Indicator",!1,!0);return rd.menu.selector(a,f())}function h(){return{seriesSelector:e(),indicatorSelector:g()}}var i=b(),j=c(),k=d();return{periods:i,sources:j,primaryChart:rd.chart.primary(k.generated),secondaryChart:rd.chart.secondary(k.generated),selectors:h(),xAxis:rd.chart.xAxis(i.day1),nav:rd.chart.nav(),navReset:rd.chart.navigationReset(),headMenu:rd.menu.head([k.generated,k.quandl],k.generated,i.day1),legend:rd.chart.legend(k.generated,i.day1),overlay:rd.menu.overlay(),notificationMessages:rd.notification.messages()}}function Ac(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function Bc(a,b,c,d){return a.map(function(a){return rd.data.product(a.id,a.id,d.get(a.id)||c,b)})}function Cc(){function b(){Q&&(Q=!1),S&&E.suspendLayout(!1),E.primary.datum(N.primaryChart).call(O.primary),E.legend.datum(N.legend).call(O.legend),E.secondaries.datum(N.secondaryChart).filter(function(a,b){return b<O.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+O.secondaries[c].valueString).call(O.secondaries[c].option)}),E.xAxis.datum(N.xAxis).call(O.xAxis),E.navbar.datum(N.nav).call(O.navbar),E.app.select("#navbar-reset").datum(N.navReset).call(I),E.app.select(".head-menu").datum(N.headMenu).call(H),E.app.select("#selectors").datum(N.selectors).call(J),E.app.select("#notifications").datum(N.notificationMessages).call(K),E.overlay.datum(N.overlay).call(G),S&&(E.suspendLayout(!0),S=!1)}function c(){S=!0,fd.layout(E,O)}function d(){a.select(window).on("resize",function(){c(),R()})}function e(a){N.notificationMessages.messages.unshift(bc(a))}function f(a){var b=[a[0],a[1]];N.primaryChart.viewDomain=b,N.secondaryChart.viewDomain=b,N.xAxis.viewDomain=b,N.nav.viewDomain=b;var c=fd.domain.trackingLatestData(N.primaryChart.viewDomain,N.primaryChart.data);N.primaryChart.trackingLatest=c,N.secondaryChart.trackingLatest=c,N.nav.trackingLatest=c,N.navReset.trackingLatest=c,R()}function g(a){a.isSelected=!a.isSelected,y(),R()}function h(a){a.isSelected=!a.isSelected,z(),R()}function i(a){N.legend.data=a,R()}function j(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):gc(a),c&&(e(c),R())}function k(){var a=N.primaryChart.data,b=bd.util.extent().fields("date")(a),c=fd.domain.moveToLatest(b,a,.2);f(c)}function l(a,b){var c='<div class="spinner"></div>',d='<div class="content alert alert-info">'+b+"</div>";E.app.select("#loading-status-message").classed("hidden",!(a||b)).html(b?d:c)}function m(a){N.primaryChart.data=a,N.secondaryChart.data=a,N.nav.data=a}function n(a){N.headMenu.selectedProduct=a,N.primaryChart.product=a,N.secondaryChart.product=a,N.legend.product=a}function o(a){N.headMenu.selectedPeriod=a,N.xAxis.period=a,N.legend.period=a}function p(a){l(!0),n(a),o(a.periods[0]),F(a.periods[0].seconds,a)}function q(){return kd.primary().on(gd.crosshairChange,i).on(gd.viewChange,f)}function r(){return kd.nav().on(gd.viewChange,f)}function s(){return ld.navigationReset().on(gd.resetToLatest,k)}function t(){return _b().on(gd.newTrade,function(a,b){if(m(a),N.primaryChart.trackingLatest){var c=fd.domain.moveToLatest(N.primaryChart.viewDomain,N.primaryChart.data);f(c)}}).on(gd.historicDataLoaded,function(a,b){l(!1),m(a),N.legend.data=null,k(),c()}).on(gd.historicFeedError,function(a,b){l(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),f=b.historicNotificationFormatter(d);f&&(c=". "+f)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;e(i),R()}).on(gd.streamingFeedError,j).on(gd.streamingFeedClose,j)}function u(){return ld.head().on(gd.dataProductChange,function(a){p(a.option),R()}).on(gd.dataPeriodChange,function(a){l(!0),o(a.option),F(a.option.seconds),R()}).on(gd.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){N.primaryChart.indicators.forEach(w),O.secondaries.forEach(w),y(),z(),R()})}function v(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function w(a){a.isSelected=!1}function x(){return ld.selectors().on(gd.primaryChartSeriesChange,function(a){N.primaryChart.series=a,v(a,N.selectors.seriesSelector.options),R()}).on(gd.primaryChartIndicatorChange,g).on(gd.secondaryChartChange,h)}function y(){N.primaryChart.indicators=N.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),N.overlay.primaryIndicators=N.primaryChart.indicators}function z(){O.secondaries=N.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
O.secondaries.forEach(function(a){a.option.on(gd.viewChange,f)}),N.overlay.secondaryIndicators=O.secondaries,
// TODO: Remove .remove! (could a secondary chart group component manage this?).
E.secondaries.selectAll("*").remove(),c()}function A(){return ld.overlay().on(gd.primaryChartIndicatorChange,g).on(gd.secondaryChartChange,h)}function B(a){N.notificationMessages.messages=N.notificationMessages.messages.filter(function(b){return b.id!==a}),R()}function C(){return md.toast().on(gd.notificationClose,B)}function D(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;N.notificationMessages.messages.unshift(bc(e))}else{var f=[N.periods.hour1,N.periods.day1],g=a.map();g.set("BTC-USD",[N.periods.minute1,N.periods.minute5,N.periods.hour1,N.periods.day1]);var h=Bc(c,N.sources.bitcoin,f,g);N.headMenu.products=N.headMenu.products.concat(h)}R()}var E,F,G,H,I,J,K,L='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div id="period-selector" class="hidden-xs hidden-sm"></div>                 <div id="mobile-period-selector" class="hidden-md hidden-lg dropdown"></div>                 <span id="clear-indicators" class="icon sc-icon-delete delete-button hidden-md hidden-lg"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row" class="hidden-xs hidden-sm">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div id="selectors">                                 <div id="series-dropdown" class="dropdown selector-dropdown"></div>                                 <div id="indicator-dropdown" class="dropdown selector-dropdown"></div>                             </div>                             <div id="legend" class="hidden-xs hidden-sm"></div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row" class="hidden-xs hidden-sm"></div>                 </div>             </div>         </div>     </div>',M={},N=zc(),O={primary:void 0,secondaries:[],xAxis:kd.xAxis(),navbar:void 0,legend:kd.legend()},P=!1,Q=!0,R=bd.util.render(b),S=!0;return M.fetchCoinbaseProducts=function(a){return arguments.length?(P=a,M):P},M.changeQuandlProduct=function(a){var b=nd.product(a,a,[N.periods.day1],N.sources.quandl,".3s"),c=N.headMenu.products.some(function(a){return a.id===b.id});c||N.headMenu.products.push(b),p(b),Q||R()},M.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var e=a.select(b);e.html(L);var f=e.select("#charts"),g=e.select("#charts-container"),h=e.select("#overlay");E={app:e,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:e.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},O.primary=q(),O.navbar=r(),F=t(),H=u(),I=s(),J=x(),G=A(),K=C(),c(),d(),F(N.headMenu.selectedPeriod.seconds,N.headMenu.selectedProduct),P?Ac(D):N.sources.bitcoin&&delete N.sources.bitcoin},bd.util.rebind(M,N.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),M}a="default"in a?a["default"]:a;var Dc=Object.freeze({randomItem:o,randomIndex:p,cloneAndReplace:q}),Ec={boundingBox:u,greedy:t,local:s,annealing:r},Fc=Object.freeze({context:v,identity:w,index:x,noop:y}),Gc=1e-6,Hc=Object.freeze({isOrdinal:A,range:B,setRange:C}),Ic={rectangles:E,strategy:Ec},Jc={dataJoin:z,expandRect:O,extent:N,fn:Fc,minimum:f,fractionalBarWidth:M,innerDimensions:L,rebind:c,rebindAll:e,scale:Hc,noSnap:G,pointSnap:H,seriesPointSnap:I,seriesPointSnapXOnly:J,seriesPointSnapYOnly:K,render:F,arrayFunctor:D,array:Dc},Kc={crosshair:W,fibonacciFan:R,container:Q,measure:P},Lc={axis:_,bar:$,candlestick:Z,ohlc:Y,errorBar:X},Mc={waterfall:aa},Nc={area:ma,bar:ka,stack:ia,line:ja},Oc={area:la,axis:qa,bar:ba,candlestick:pa,cycle:oa,line:ha,multi:T,ohlc:na,point:V,stacked:Nc,groupedBar:ga,xyBase:U,ohlcBase:fa,errorBar:ea,waterfall:ca,algorithm:Mc};ua.tickTransformer=sa;var Pc={discontinuity:{identity:ra,skipWeekends:va},dateTime:ua},Qc={bollingerBands:Ca,macd:Ba,relativeStrengthIndex:Aa,stochasticOscillator:za,forceIndex:ya,envelope:xa,elderRay:wa},Rc={bollingerBands:Wa,exponentialMovingAverage:Da,macd:Sa,percentageChange:Va,relativeStrengthIndex:Pa,stochasticOscillator:Na,slidingWindow:Fa,undefinedInputAdapter:Ja,forceIndex:La,envelope:Ia,elderRay:Ea},Sc={bollingerBands:Xa,calculator:Rc,exponentialMovingAverage:Ua,macd:Ta,merge:Ga,movingAverage:Ra,relativeStrengthIndex:Qa,stochasticOscillator:Oa,forceIndex:Ma,envelope:Ka,elderRay:Ha},Tc={algorithm:Sc,renderer:Qc},Uc={modeMedian:_a,largestTriangleThreeBucket:$a,largestTriangleOneBucket:Za,bucket:Ya},Vc={filter:{skipWeekends:db},financial:cb,walk:bb},Wc={coinbase:fb,quandl:eb},Xc={feed:Wc,random:Vc,spread:ab,sampler:Uc};/**
...
sXML="<svg xmlns='http://www.w3.org/2000/svg'>"+a+"</svg>";for(var c=b.parseFromString(sXML,"text/xml").documentElement,d=c.firstChild;d;)this.appendChild(this.ownerDocument.importNode(d,!0)),d=d.nextSibling}catch(e){throw new Error("Error parsing XML string")}}})}}((1,eval)("this").SVGElement);var Yc={cartesian:jb,sparkline:ib,tooltip:hb,smallMultiples:gb},Zc={band:lb,gridline:kb,line:S},$c=b(function(a,b){
...
c.fillNodes(a),c.computeLayout(a)}})}),_c=$c&&"object"==typeof $c&&"default"in $c?$c["default"]:$c;a.selection.prototype.layoutSuspended=tb,a.transition.prototype.layoutSuspended=tb,a.selection.prototype.layout=ub,a.transition.prototype.layout=ub;
// Needs to be defined like this so that the grunt task can update it
var ad="development",bd={annotation:Zc,chart:Yc,data:Xc,indicator:Tc,scale:Pc,series:Oc,svg:Lc,tool:Kc,util:Jc,version:ad,layout:Ic},cd=0,dd=!1,ed={centerOnDate:Ab,filterDataInDateRange:zb,moveToLatest:yb,trackingLatestData:xb},fd={domain:ed,layout:wb,uid:vb},gd={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},hd={base:Cb,macd:Fb,rsi:Eb,volume:Db},id=b(function(a){/*!
...
"string"!=typeof c&&(d=d||c,c=void 0);for(h in b)q(a,h,c,d,b[h],f);return a}if(null==d&&null==e?(e=c,d=c=void 0):null==e&&("string"==typeof c?(e=d,d=void 0):(e=d,d=c,c=void 0)),e===!1)e=o;else if(!e)return this;
// Use same guid so caller can remove using origFn
return 1===f&&(g=e,e=function(a){return fa().off(a),g.apply(this,arguments)},e.guid=g.guid||(g.guid=fa.guid++)),a.each(function(){fa.event.add(this,b,e,d,c)})}function r(a,b){return fa.nodeName(a,"table")&&fa.nodeName(11!==b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a:a}
...
return c=c||Ya(a),c&&(g=c.getPropertyValue(b)||c[b],""!==g||fa.contains(a.ownerDocument,a)||(g=fa.style(a,b)),!da.pixelMarginRight()&&Xa.test(g)&&Wa.test(b)&&(d=h.width,e=h.minWidth,f=h.maxWidth,h.minWidth=h.maxWidth=h.width=g,g=c.width,h.width=d,h.minWidth=e,h.maxWidth=f)),void 0!==g?g+"":g}function B(a,b){
...
//"use strict";
var W=[],X=a.document,Y=W.slice,Z=W.concat,$=W.push,_=W.indexOf,aa={},ba=aa.toString,ca=aa.hasOwnProperty,da={},ea="2.2.0",
...
// - DOM nodes
// - window
return"object"!==fa.type(a)||a.nodeType||fa.isWindow(a)?!1:a.constructor&&!ca.call(a.constructor.prototype,"isPrototypeOf")?!1:!0},isEmptyObject:function(a){var b;for(b in a)return!1;return!0},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?aa[ba.call(a)]||"object":typeof a},
...
var c=b.ownerDocument.defaultView;return c.opener||(c=a),c.getComputedStyle(b)},Za=function(a,b,c,d){var e,f,g={};
...
return"fixed"===fa.css(c,"position")?b=c.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),fa.nodeName(a[0],"html")||(d=a.offset()),d.top+=fa.css(a[0],"borderTopWidth",!0)-a.scrollTop(),d.left+=fa.css(a[0],"borderLeftWidth",!0)-a.scrollLeft()),{top:b.top-d.top-fa.css(c,"marginTop",!0),left:b.left-d.left-fa.css(c,"marginLeft",!0)}}},
...
return fa.noConflict=function(b){return a.$===fa&&(a.$=Nb),b&&a.jQuery===fa&&(a.jQuery=Mb),fa},b||(a.jQuery=a.$=fa),fa})}),jd=id&&"object"==typeof id&&"default"in id?id["default"]:id,kd={legend:Pb,nav:Ob,primary:Mb,xAxis:Gb,secondary:hd},ld={head:Yb,selectors:Ub,navigationReset:Sb,overlay:Rb},md={toast:ac},nd={period:ec,product:dc,source:cc},od={message:bc,messages:hc},pd={legend:nc,nav:mc,navigationReset:lc,primary:kc,secondary:jc,xAxis:ic},qd={head:rc,periodAdaptor:Wb,productAdaptor:Vb,overlay:qc,dropdownConfig:pc,option:Hb,selector:oc},rd={menu:qd,chart:pd,data:nd,notification:od},sd={app:Cc};sd.app().fetchCoinbaseProducts(!0).run("#app-container")});