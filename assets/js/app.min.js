...
var a=null;a=(1,eval)("this"),a.sc={behavior:{},chart:{secondary:{}},data:{feed:{coinbase:{}}},menu:{data:{},generator:{},primary:{},secondary:{}},model:{chart:{},data:{},menu:{}},series:{},util:{domain:{}}}}(),function(a,b,c){"use strict";c.event={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",dataLoaded:"dataLoaded",dataLoadError:"dataLoadError",webSocketError:"webSocketError",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange"}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.legend=function(a,b){return{data:void 0,product:a,period:b}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.nav=function(){return{data:[],viewDomain:[],trackingLatest:!0}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.navigationReset=function(){return{trackingLatest:!0}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.primary=function(a){var b={data:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0},d=a;Object.defineProperty(b,"product",{get:function(){return d},set:function(a){d=a,b.selectorsChanged=!0}});var e=c.series.candlestick();e.id=c.util.uid();var f=c.model.menu.option("Candlestick","candlestick",e);Object.defineProperty(b,"series",{get:function(){return f},set:function(a){f=a,b.selectorsChanged=!0}});var g={option:function(a){return a.close}};Object.defineProperty(b,"yValueAccessor",{get:function(){return g},set:function(a){g=a,b.selectorsChanged=!0}});var h=[];return Object.defineProperty(b,"indicators",{get:function(){return h},set:function(a){h=a,b.selectorsChanged=!0}}),b}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.secondary=function(a){return{data:[],viewDomain:[],trackingLatest:!0,product:a}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.chart.xAxis=function(a){return{viewDomain:[],period:a}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.data.period=function(b){return b=b||{},{display:b.display||"1 day",seconds:b.seconds||86400,d3TimeInterval:b.d3TimeInterval||{unit:a.time.day,value:1},timeFormat:a.time.format(b.timeFormat||"%b %d")}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.data.product=function(b){return{display:b.display||"Unspecified Product",priceFormat:a.format(b.priceFormat||".2f"),volumeFormat:a.format(b.volumeFormat||"s"),periods:b.periods||[]}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.head=function(a,b,c){return{productConfig:{title:null,careted:!0,listIcons:!1,icon:!1},products:a,selectedProduct:b,selectedPeriod:c}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.indicatorOptions=function(){var a=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).yValue(function(a){return a.movingAverage});a.id=c.util.uid();var d=b.indicator.renderer.bollingerBands();return d.id=c.util.uid(),[c.model.menu.option("Moving Average","movingAverage",a,"sc-icon-moving-average-indicator"),c.model.menu.option("Bollinger Bands","bollinger",d,"sc-icon-bollinger-bands-indicator")]}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.indicatorSelector=function(){return{config:{title:"Add Indicator",careted:!1,listIcons:!0,icon:!1},indicatorOptions:c.model.menu.indicatorOptions(),secondaryChartOptions:c.model.menu.secondaryChartOptions()}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.option=function(a,b,c,d){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d}}}(d3,fc,sc),function(a,b,c){"use strict";
// Generates a menu option similar to those generated by sc.model.menu.option from a sc.model.data.period object
c.model.menu.periodAdaptor=function(a){return{displayString:a.display,option:a}}}(d3,fc,sc),function(a,b,c){"use strict";
// Generates a menu option similar to those generated by sc.model.menu.option from a sc.model.data.product object
c.model.menu.productAdaptor=function(a){return{displayString:a.display,option:a}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.secondaryChartOptions=function(){return[c.model.menu.option("Relative Strength Index","secondary-rsi",c.chart.secondary.rsi(),"sc-icon-rsi-indicator"),c.model.menu.option("MACD","secondary-macd",c.chart.secondary.macd(),"sc-icon-macd-indicator"),c.model.menu.option("Volume","secondary-volume",c.chart.secondary.volume(),"sc-icon-bar-series")]}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.selectors=function(){
// TODO: Instantiate series/indicator components outside of menu model?
return{seriesSelector:c.model.menu.seriesSelector(),indicatorSelector:c.model.menu.indicatorSelector()}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.seriesOptions=function(){
// TODO: Could 'isLine' go on primary chart series model instead?
var a=b.series.line();a.isLine=!0;var d=c.menu.option("Candlestick","candlestick",c.series.candlestick());return d.isSelected=!0,[d,c.menu.option("OHLC","ohlc",b.series.ohlc()),c.menu.option("Line","line",a),c.menu.option("Point","point",b.series.point()),c.menu.option("Area","area",b.series.area())]}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.seriesSelector=function(){var a=c.series.candlestick();a.id=c.util.uid();var d=c.model.menu.option("Candlestick","candlestick",a,"sc-icon-candlestick-series");d.isSelected=!0;var e=b.series.ohlc();e.id=c.util.uid();var f=b.series.line();f.id=c.util.uid();var g=b.series.point();g.id=c.util.uid();var h=b.series.area();return h.id=c.util.uid(),{config:{title:null,careted:!1,listIcons:!0,icon:!0},options:[d,c.model.menu.option("OHLC","ohlc",e,"sc-icon-ohlc-series"),c.model.menu.option("Line","line",f,"sc-icon-line-series"),c.model.menu.option("Point","point",g,"sc-icon-point-series"),c.model.menu.option("Area","area",h,"sc-icon-area-series")]}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.side=function(){
// TODO: Instantiate series/indicator components outside of menu model?
return{seriesOptions:c.model.menu.seriesOptions(),yValueAccessorOptions:c.model.menu.yValueAccessorOptions(),// TODO: remove? #263.
indicatorOptions:c.model.menu.indicatorOptions(),secondaryChartOptions:c.model.menu.secondaryChartOptions()}}}(d3,fc,sc),function(a,b,c){"use strict";c.model.menu.yValueAccessorOptions=function(){var a=c.model.menu.option("Close","close",function(a){return a.close});return a.isSelected=!0,[c.model.menu.option("Open","open",function(a){return a.open}),c.model.menu.option("High","high",function(a){return a.high}),c.model.menu.option("Low","low",function(a){return a.low}),a]}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.legend=function(){function b(b){b.each(function(b){var h=a.select(this);if(c=b.product.priceFormat,d=b.product.volumeFormat,e=b.period.timeFormat,null==b.data||b.data!==f){f=b.data;var i=h.selectAll("span").data(g);i.enter().append("span").attr("class",function(a,b){return b%2===0?"legendLabel":"legendValue"}),i.text(function(a,c){var d="";return c%2===0?a:b.data?a(b.data):d})}})}var c,d,e,f,g=["T",function(a){return e(a.date)},"O",function(a){return c(a.open)},"H",function(a){return c(a.high)},"L",function(a){return c(a.low)},"C",function(a){return c(a.close)},"V",function(a){return d(a.volume)}];return b}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.nav=function(){function d(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function e(a){return a.extent()[0][0]-a.extent()[1][0]===0}function f(a){var f=a.datum();s.domain(f.viewDomain);var h=c.util.domain.filterDataInDateRange(b.util.extent().fields("date")(f.data),f.data),i=b.util.extent().fields(["low","high"])(h);r.xDomain(b.util.extent().fields("date")(f.data)).yDomain(i),v.on("brush",function(){var b=e(v);
// Hide the bar if the extent is empty
d(a,b),b||q[c.event.viewChange]([v.extent()[0][0],v.extent()[1][0]])}).on("brushend",function(){var b=e(v);d(a,!1),b&&q[c.event.viewChange](c.util.domain.centerOnDate(s.domain(),f.data,v.extent()[0][0]))}),r.plotArea(w),a.call(r);
// Allow to zoom using mouse, but disable panning
var j=c.behavior.zoom(g).scale(s).trackingLatest(f.trackingLatest).allowPan(!1).on("zoom",function(a){q[c.event.viewChange](a)});a.select(".plot-area").call(j)}var g,h=100,i=40,j=h-i,k=2,l=k/2,m=j-l,n=m,o=l+n/2,p=2,q=a.dispatch(c.event.viewChange),r=b.chart.cartesian(b.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:i}),s=b.scale.dateTime(),t=b.series.area().yValue(function(a){return a.close}),u=b.series.line().yValue(function(a){return a.close}),v=a.svg.brush(),w=b.series.multi().series([t,u,v]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",m).attr("y",k/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",o).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",o).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==v?this.data:void v.extent([[s.domain()[0],r.yDomain()[0]],[s.domain()[1],r.yDomain()[1]]])});return a.rebind(f,q,"on"),f.dimensionChanged=function(a){g=parseInt(a.style("width"),10),s.range([0,g])},f}}(d3,fc,sc),function(a,b,c){"use strict";function d(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function e(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function f(c,d,e){var f;switch(d.valueString){case"candlestick":case"ohlc":f=[d.option.yLowValue(),d.option.yHighValue()];break;case"line":case"point":f=d.option.yValue();break;case"area":f=d.option.y1Value();break;default:throw new Error("Main series given to chart does not have expected interface")}var g=b.util.extent().fields(f)(c);if(e.length){var h=e.map(function(a){return a.valueString}),i=-1!==h.indexOf("movingAverage"),j=-1!==h.indexOf("bollinger");if(j){var k=c.map(function(a){return a.bollingerBands}),l=b.util.extent().fields(["lower","upper"])(k);g[0]=a.min([l[0],g[0]]),g[1]=a.max([l[1],g[1]])}if(i){var m=b.util.extent().fields("movingAverage")(c);g[0]=a.min([m[0],g[0]]),g[1]=a.max([m[1],g[1]])}if(!i&&!j)throw new Error("Unexpected indicator type")}return g}c.chart.primary=function(){function g(){var a=[v,n.option,w],b=s.map(function(a){return a.option});return a.concat(b,u)}function h(){switch(B.value(r),C.value(r),w.value(r),n.valueString){case"line":case"point":case"area":n.option.yValue(r)}}
// Call when what to display on the chart is modified (ie series, options)
function i(a){n=a.series,r=a.yValueAccessor.option,s=a.indicators,h(),x.series(g()),A.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function j(a){var b=n.option.width(a);u.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function k(a){a.classed("band",!1).selectAll("line").style("stroke-width",null)}function l(a){"candlestick"===n.valueString||"ohlc"===n.valueString?j(a):u.decorate(k)}function m(g){var h=g.datum();h.selectorsChanged&&i(h),A.xDomain(h.viewDomain),u.snap(b.util.seriesPointSnapXOnly(n.option,h.data)),l(h.data),B(h.data),C(h.data);
// Scale y axis
var j=c.util.domain.filterDataInDateRange(A.xDomain(),h.data),k=f(j,n,s),m=c.util.domain.padYDomain(k,.04);A.yDomain(m);
// Find current tick values and add close price to this list, then set it explicitly below
var t=r(h.data[h.data.length-1]),v=e(z,[t]);A.yTickValues(v).yDecorate(function(b){b.selectAll(".tick").filter(function(a){return a===t}).classed("closeLine",!0).select("path").attr("d",function(b){return a.svg.area()(d(p,14))})}),
// Redraw
A.plotArea(x),g.call(A);var w=c.behavior.zoom(o).scale(y).trackingLatest(h.trackingLatest).on("zoom",function(a){q[c.event.viewChange](a)});g.select(".plot-area").call(w)}var n,o,p=60,q=a.dispatch(c.event.viewChange,c.event.crosshairChange),r=function(a){return a.close},s=[],t=[],u=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?q.crosshairChange(a[0].datum):q.crosshairChange(void 0)}).on("trackingend",function(){q.crosshairChange(void 0)});u.id=c.util.uid();var v=b.annotation.gridline().yTicks(5).xTicks(0),w=b.annotation.line().orient("horizontal").value(r).label("");w.id=c.util.uid();var x=b.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case w:return[this.data[this.data.length-1]];case u:return t;default:return this.data}}),y=b.scale.dateTime(),z=a.scale.linear(),A=b.chart.cartesian(y,z).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:p}),B=b.indicator.algorithm.movingAverage(),C=b.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(m,q,"on"),m.dimensionChanged=function(a){o=parseInt(a.style("width"),10)-p},m}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.secondary.base=function(){function d(b){b.each(function(d){var h=a.select(this).call(l),j=c.behavior.zoom(e).scale(g).trackingLatest(i).on("zoom",function(a){f[c.event.viewChange](a)});h.select(".plot-area-container").datum({data:b.datum()}).call(j)})}var e,f=a.dispatch(c.event.viewChange),g=b.scale.dateTime(),h=a.scale.linear(),i=!0,j=60,k=b.series.multi(),l=b.chart.cartesian(g,h).plotArea(k).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:j});return d.trackingLatest=function(a){return arguments.length?(i=a,d):i},a.rebind(d,f,"on"),a.rebind(d,k,"series","mapping","decorate"),a.rebind(d,l,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),d.dimensionChanged=function(a){e=parseInt(a.style("width"),10)-j},d}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.secondary.macd=function(){function d(a){var c=a.datum();h(c.data);var d=b.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(c.data.map(function(a){return a.macd}));i.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c.data).call(i)}var e=a.dispatch(c.event.viewChange),f=b.annotation.line().value(0).label(""),g=b.indicator.renderer.macd(),h=b.indicator.algorithm.macd(),i=c.chart.secondary.base().series([f,g]).yTicks(5).mapping(function(a){return a===f?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(c.event.viewChange,function(a){e[c.event.viewChange](a)});return a.rebind(d,e,"on"),d.dimensionChanged=function(a){i.dimensionChanged(a)},d}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.secondary.rsi=function(){function d(a){var b=a.datum();g(b.data),i.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b.data).call(i)}var e=a.dispatch(c.event.viewChange),f=b.indicator.renderer.relativeStrengthIndex(),g=b.indicator.algorithm.relativeStrengthIndex(),h=[f.lowerValue(),50,f.upperValue()],i=c.chart.secondary.base().series([f]).yTickValues(h).on(c.event.viewChange,function(a){e[c.event.viewChange](a)});return a.rebind(d,e,"on"),d.dimensionChanged=function(a){i.dimensionChanged(a)},d}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.secondary.volume=function(){function d(a){a.each(function(c){var d=b.util.extent().fields("volume").pad(.08)(c.data);d[0]<0&&(d[0]=0),g.yTickFormat(c.product.volumeFormat).trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c.data).call(g)})}var e=a.dispatch(c.event.viewChange),f=b.series.bar().yValue(function(a){return a.volume}),g=c.chart.secondary.base().series([f]).yTicks(4).on(c.event.viewChange,function(a){e[c.event.viewChange](a)});return a.rebind(d,e,"on"),d.dimensionChanged=function(a){g.dimensionChanged(a)},d}}(d3,fc,sc),function(a,b,c){"use strict";c.chart.xAxis=function(){function c(a){var b=(e.ticks()[1]-e.ticks()[0])/1e3;b<a.seconds?f.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):f.ticks(6)}function d(a){var b=a.datum();e.domain(b.viewDomain),c(b.period),a.call(f)}var e=b.scale.dateTime(),f=a.svg.axis().scale(e).orient("bottom");return d.dimensionChanged=function(a){e.range([0,parseInt(a.style("width"),10)])},d}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.generator.buttonGroup=function(){function c(b){b.each(function(b){var c=a.select(this);e(c,b.options).classed("active",function(a){return a.isSelected}).classed("btn btn-primary",!0).text(function(a){return a.displayString}).on("click",d.optionChange)})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector(".button").element("label").attr("class","button");return a.rebind(c,d,"on"),c}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.generator.dropdown=function(){function c(a){var b=a.datum(),c=b.selectedIndex||0,i=b.config,j=e(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[c].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[c].displayString});f(j,i.careted?[0]:[]);var l=g(a,[b.options]),m=h(l,b.options),n=m.enter().on("click",d.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),f=b.util.dataJoin().selector(".caret").element("span").attr("class","caret"),g=b.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),h=b.util.dataJoin().selector("li").element("li");return a.rebind(c,d,"on"),c}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.generator.dropdownGroup=function(){function c(a){var c=a.datum().selectedIndex||0,f=a.datum(),g=e(a,[f.options]);g.attr("class","dropdown-menu");var h=g.selectAll("li").data(b.util.fn.identity);h.enter().append("li").on("click",d.optionChange).append("a").attr("href","#"),h.select("a").text(function(a){return a.displayString}),a.select("#product-dropdown-button").html(function(a){return f.options[c].displayString+'<span class="caret"></span>'})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.generator.tabGroup=function(){function c(a){var c=a.datum().selectedIndex||0,f=e(a,[a.datum().options]);f.enter().append("ul");var g=f.selectAll("li").data(b.util.fn.identity);g.enter().append("li").append("a").attr("href","#").on("click",d.tabClick),g.classed("active",function(a,b){return b===c}).select("a").text(function(a){return a.displayString})}var d=a.dispatch("tabClick"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.head=function(){var b=a.dispatch(c.event.dataProductChange,c.event.dataPeriodChange),d=c.menu.generator.dropdown().on("optionChange",function(a){b[c.event.dataProductChange](a)}),e=c.menu.generator.tabGroup().on("tabClick",function(a){b[c.event.dataPeriodChange](a)}),f=function(b){b.each(function(b){var f=a.select(this),g=b.products;f.select("#product-dropdown").datum({config:b.productConfig,options:g.map(c.model.menu.productAdaptor),selectedIndex:g.indexOf(b.selectedProduct)}).call(d);var h=b.selectedProduct.periods;f.select("#period-selector").classed("hidden",h.length<=1).datum({options:h.map(c.model.menu.periodAdaptor),selectedIndex:h.indexOf(b.selectedPeriod)}).call(e)})};return a.rebind(f,b,"on")}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.navigationReset=function(){function b(a){var b=a.datum(),e=a.selectAll("g").data([b]);e.enter().append("g").attr("class","reset-button").on("click",function(){d[c.event.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),e.classed("active",!b.trackingLatest)}var d=a.dispatch(c.event.resetToLatest);return a.rebind(b,d,"on"),b}}(d3,fc,sc),function(a,b,c){"use strict";
// TODO: Move to /model
...
c.menu.productAdaptor=function(a){return{displayString:a.display,option:a}},/**
     ...
     */
c.menu.periodAdaptor=function(a){return{displayString:a.display,option:a}}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.selectors=function(){var b=a.dispatch(c.event.primaryChartSeriesChange,c.event.primaryChartIndicatorChange,c.event.secondaryChartChange),d=c.menu.generator.dropdown().on("optionChange",b[c.event.primaryChartSeriesChange]),e=c.menu.generator.dropdown().on("optionChange",function(a){0===a.valueString.indexOf("secondary")?b[c.event.secondaryChartChange](a):b[c.event.primaryChartIndicatorChange](a)}),f=function(b){b.each(function(b){var c=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);c.select("#series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(d);var g=b.indicatorSelector.indicatorOptions.concat(b.indicatorSelector.secondaryChartOptions),h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});c.select("#indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(e)})};return a.rebind(f,b,"on")}}(d3,fc,sc),function(a,b,c){"use strict";c.menu.side=function(){var b=a.dispatch(c.event.primaryChartSeriesChange,c.event.primaryChartYValueAccessorChange,c.event.primaryChartIndicatorChange,c.event.secondaryChartChange),d=c.menu.generator.buttonGroup().on("optionChange",b[c.event.primaryChartSeriesChange]),e=c.menu.generator.buttonGroup().on("optionChange",b[c.event.primaryChartYValueAccessorChange]),f=c.menu.generator.buttonGroup().on("optionChange",b[c.event.primaryChartIndicatorChange]),g=c.menu.generator.buttonGroup().on("optionChange",b[c.event.secondaryChartChange]),h=function(b){b.each(function(b){var c=a.select(this);c.select(".series-buttons").datum({options:b.seriesOptions}).call(d),c.select(".y-value-accessor-buttons").datum({options:b.yValueAccessorOptions}).call(e),c.select(".indicator-buttons").datum({options:b.indicatorOptions}).call(f),c.select(".secondary-chart-buttons").datum({options:b.secondaryChartOptions}).call(g)})};return a.rebind(h,b,"on")}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.centerOnDate=function(c,d,e){var f=b.util.extent().fields("date")(d),g=c.map(function(a){return a.getTime()}),h=(a.max(g)-a.min(g))/1e3;if(e.getTime()<f[0]||e.getTime()>f[1])return[new Date(a.min(g)),new Date(a.max(g))];var i=[a.time.second.offset(e,-h/2),a.time.second.offset(e,h/2)],j=0;return i[1].getTime()>f[1].getTime()?j=(f[1].getTime()-i[1].getTime())/1e3:i[0].getTime()<f[0].getTime()&&(j=(f[0].getTime()-i[0].getTime())/1e3),[a.time.second.offset(i[0],j),a.time.second.offset(i[1],j)]}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.checkViewDomain=function(a){return a.viewDomain[0].getTime()!==a.viewDomain[1].getTime()}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.filterDataInDateRange=function(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.getArbitraryDomain=function(){var a=new Date(2015,0,1,0,0,0),b=new Date(2015,0,2,0,0,0);return[a,b]}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.moveToLatest=function(c,d,e){arguments.length<3&&(e=1);var f=b.util.extent().fields("date")(d),g=(f[1].getTime()-f[0].getTime())/1e3,h=c.map(function(a){return a.getTime()}),i=e*(a.max(h)-a.min(h))/1e3,j=g>i?[a.time.second.offset(f[1],-i),f[1]]:f;return j}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.padYDomain=function(a,b){var c=Array.isArray(b)?b:[b,b],d=a[1]-a[0];return[a[0]-d*c[0],a[1]+d*c[1]]}}(d3,fc,sc),function(a,b,c){"use strict";c.util.domain.trackingLatestData=function(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}}(d3,fc,sc),/*global window */
function(a,b,c,d){"use strict";var e=!1;c.util.layout=function(a,b){function c(b){return a.secondaries.filter(function(a,c){return c===b})}for(var f=0,g=0;g<b.secondaries.length;g++)b.secondaries[g]&&f++;a.secondaries.filter(function(a,b){return f>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=f}).style("flex","0");var h=parseInt(a.app.select(".head-row").style("height"),10);e||(h+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),e=!0);var i=d.innerHeight-h;a.charts.style("height",i+"px"),b.xAxis.dimensionChanged(a.xAxis),b.navbar.dimensionChanged(a.navbar),b.primary.dimensionChanged(a.primary);for(var j=0;j<b.secondaries.length;j++)b.secondaries[j].option.dimensionChanged(c(j))}}(d3,fc,sc,window),function(a,b,c){"use strict";var d=0;c.util.uid=function(){return++d}}(d3,fc,sc),function(a,b,c){"use strict";c.data.callbackInvalidator=function(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}}(d3,fc,sc),function(a,b,c){"use strict";c.data.collectOhlc=function(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}}(d3,fc,sc),function(a,b,c){"use strict";c.data.dataInterface=function(){
// TODO: configurable product.
function d(b){var c=new Date,d=a.time.second.offset(c,-n*b);h.start(d).end(c)}function e(a){f(),h.granularity(a),d(a),l.granularity(a),h(i(function(a,b){a?m[c.event.dataLoadError](a):(o=b,m[c.event.dataLoaded](g(o)))})),k.on("message",function(a){l(o,a),m[c.event.newTrade](o)}),k.on("error",function(a){
// TODO: The 'close' event is potentially more useful for error info.
m[c.event.webSocketError](a)}),k()}function f(){k.close(),o=[],i.invalidateCallback()}function g(a){return a.sort(function(a,b){return a.date-b.date})}var h=b.data.feed.coinbase(),i=c.data.callbackInvalidator(),j=b.data.random.financial(),k=c.data.feed.coinbase.webSocket(),l=c.data.collectOhlc().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),m=a.dispatch(c.event.newTrade,c.event.dataLoaded,c.event.dataLoadError,c.event.webSocketError),n=200,o=[];
// TODO: remove? - #407
return e.generateDailyData=function(){f();var a=new Date;a.setHours(0,0,0,0);var b=864e5;j.startDate(new Date(a-(n-1)*b));var d=j(n);m[c.event.dataLoaded](d)},a.rebind(e,m,"on"),e}}(d3,fc,sc),function(a,b,c){"use strict";c.data.feed.coinbase.ohlcWebSocketAdaptor=function(){function b(a,b){return{date:b,open:a.price,close:a.price,low:a.price,high:a.price,volume:a.volume}}function d(a,c){null==a&&(a=b(c,c.date));var d=c.date.getTime(),e=a.date.getTime(),g=1e3*f;if(d>e+g){var h=(d-e)%g,i=d-h;a=b(c,new Date(i))}else
...
// In seconds
var f=86400,g=c.data.feed.coinbase.webSocket();return e.period=function(a){return arguments.length?(f=a,e):f},a.rebind(e,g,"product","messageType","close"),e}}(d3,fc,sc),/*global WebSocket */
function(a,b,c){"use strict";
// https://docs.exchange.coinbase.com/#websocket-feed
c.data.feed.coinbase.webSocket=function(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.exchange.coinbase.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){b&&b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}}(d3,fc,sc),function(a,b,c){"use strict";c.behavior.zoom=function(d){function e(a){
// Don't pan off sides
// Don't pan off sides
...
h()}else h()}),a.call(l)}var j,k=a.dispatch("zoom"),l=a.behavior.zoom(),m=!0,n=!0,o=!0;return i.allowPan=function(a){return arguments.length?(m=a,i):m},i.allowZoom=function(a){return arguments.length?(n=a,i):n},i.trackingLatest=function(a){return arguments.length?(o=a,i):o},i.scale=function(a){return arguments.length?(j=a,i):j},a.rebind(i,k,"on"),i}}(d3,fc,sc),function(a,b,c){"use strict";/* Credit to Chris Price for this optimisation
    ...
    */
c.series.candlestick=function(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a,b){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a,b){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n}}(d3,fc,sc),/*global window */
function(a,b,c,d){"use strict";c.app=function(){function e(){S&&B.suspendLayout(!1),B.primary.datum(I).call(Q.primary),B.legend.datum(P).call(Q.legend),B.secondaries.datum(J).filter(function(a,b){return b<Q.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+Q.secondaries[c].valueString).call(Q.secondaries[c].option)}),B.xAxis.datum(L).call(Q.xAxis),B.navbar.datum(M).call(Q.navbar),B.app.select("#navbar-reset").datum(N).call(w),B.app.select(".head-menu").datum(O).call(v),B.app.select("#selectors").datum(K).call(x),S&&(B.suspendLayout(!0),S=!1)}function f(){S=!0,c.util.layout(B,Q)}function g(){a.select(d).on("resize",function(){f(),R()})}function h(a){var b=[a[0],a[1]];I.viewDomain=b,J.viewDomain=b,L.viewDomain=b,M.viewDomain=b;var d=c.util.domain.trackingLatestData(I.viewDomain,I.data);I.trackingLatest=d,J.trackingLatest=d,M.trackingLatest=d,N.trackingLatest=d,R()}function i(a){P.data=a,R()}function j(){var a=I.data,d=b.util.extent().fields("date")(a),e=c.util.domain.moveToLatest(d,a,.2);h(e)}function k(a){z.select("#loading-message").classed("hidden",!a),z.select("#charts").classed("hidden",a)}function l(a){I.data=a,J.data=a,M.data=a}function m(a){O.selectedProduct=a,I.product=a,J.product=a,P.product=a}function n(a){O.selectedPeriod=a,L.period=a,P.period=a}function o(){return c.chart.primary().on(c.event.crosshairChange,i).on(c.event.viewChange,h)}function p(){return c.chart.nav().on(c.event.viewChange,h)}function q(){return c.menu.navigationReset().on(c.event.resetToLatest,j)}function r(){return c.data.dataInterface().on(c.event.newTrade,function(a){if(l(a),I.trackingLatest){var b=c.util.domain.moveToLatest(I.viewDomain,I.data);h(b)}}).on(c.event.dataLoaded,function(a){k(!1),l(a),P.data=null,j(),f()}).on(c.event.dataLoadError,function(a){console.log("Error getting historic data: "+a)}).on(c.event.webSocketError,function(a){console.log("Error loading data from websocket: "+a)})}function s(a){return c.menu.head().on(c.event.dataProductChange,function(b){k(!0),m(b.option),n(b.option.periods[0]),b.option===H?a(b.option.periods[0].seconds):b.option===G&&a.generateDailyData(),R()}).on(c.event.dataPeriodChange,function(b){k(!0),n(b.option),a(b.option.seconds),R()})}function t(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function u(){return c.menu.selectors().on(c.event.primaryChartSeriesChange,function(a){I.series=a,t(a,K.seriesSelector.options),R()}).on(c.event.primaryChartIndicatorChange,function(a){a.isSelected=!a.isSelected,I.indicators=K.indicatorSelector.indicatorOptions.filter(function(a){return a.isSelected}),R()}).on(c.event.secondaryChartChange,function(a){a.isSelected=!a.isSelected,Q.secondaries=K.indicatorSelector.secondaryChartOptions.filter(function(a){return a.isSelected}),
// TODO: This doesn't seem to be a concern of menu.
Q.secondaries.forEach(function(a){a.option.on(c.event.viewChange,h)}),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
B.secondaries.selectAll("*").remove(),f(),R()})}var v,w,x,y={},z=a.select("#app-container"),A=z.select("#charts-container"),B={app:z,charts:A,primary:A.select("#primary-container"),secondaries:A.selectAll(".secondary-container"),xAxis:A.select("#x-axis-container"),navbar:A.select("#navbar-container"),legend:z.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},C=c.model.data.period({display:"Daily",seconds:86400,d3TimeInterval:{unit:a.time.day,value:1},timeFormat:"%b %d"}),D=c.model.data.period({display:"1 Hr",seconds:3600,d3TimeInterval:{unit:a.time.hour,value:1},timeFormat:"%b %d %Hh"}),E=c.model.data.period({display:"5 Min",seconds:300,d3TimeInterval:{unit:a.time.minute,value:5},timeFormat:"%H:%M"}),F=c.model.data.period({display:"1 Min",seconds:60,d3TimeInterval:{unit:a.time.minute,value:1},timeFormat:"%H:%M"}),G=c.model.data.product({display:"Data Generator",volumeFormat:".3s",periods:[C]}),H=c.model.data.product({display:"Bitcoin",volumeFormat:".2f",periods:[F,E,D]}),I=c.model.chart.primary(G),J=c.model.chart.secondary(G),K=c.model.menu.selectors(),L=c.model.chart.xAxis(C),M=c.model.chart.nav(),N=c.model.chart.navigationReset(),O=c.model.menu.head([G,H],G,C),P=c.model.chart.legend(G,C),Q={primary:void 0,secondaries:[],xAxis:c.chart.xAxis(),navbar:void 0,legend:c.chart.legend()},R=b.util.render(e),S=!0;return y.run=function(){Q.primary=o(),Q.navbar=p();var a=r();v=s(a),w=q(),x=u(),g(),a.generateDailyData()},y}}(d3,fc,sc,window),function(a,b,c){"use strict";c.app().run()}(d3,fc,sc);