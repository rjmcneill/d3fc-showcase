...
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}
// TODO: Temp until merged into d3fc
function f(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
return g=a.time.day.offset(g,7*l),h-=l*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function g(a,b){var c=!1;return Array.isArray(b)||(b=[b]),b.forEach(function(b){a===b&&(c=!0)}),f()}function h(c,d,e){arguments.length<3&&(e=1);var f=b.util.extent().fields("date")(d),g=(f[1].getTime()-f[0].getTime())/1e3,h=c.map(function(a){return a.getTime()}),i=e*(a.max(h)-a.min(h))/1e3,j=g>i?[a.time.second.offset(f[1],-i),f[1]]:f;if(6===j[0].getDay()||0===j[0].getDay()){var k=a.time.friday.floor(j[0]),l=a.time.saturday.floor(j[0]),m=a.time.monday.ceil(j[0]),n=(j[0].getTime()-l.getTime())/(m.getTime()-l.getTime()),o=864e5*n;console.log(n),console.log(j[0]),j[0]=new Date(k.getTime()+o),console.log(j[0])}return j}function i(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function j(a,c){function d(b){return a.secondaries.filter(function(a,c){return c===b})}for(var e=0,f=0;f<c.secondaries.length;f++)c.secondaries[f]&&e++;a.secondaries.filter(function(a,b){return e>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=e}).style("flex","0"),a.overlaySecondaries.filter(function(a,b){return e>b}).style("flex","1"),a.overlaySecondaries.filter(function(a,b){return b>=e}).style("flex","0");var g=parseInt(a.app.select(".head-row").style("height"),10);pa||(g+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),pa=!0);var h=b.util.innerDimensions(a.app.node()).height-g;a.chartsAndOverlay.style("height",h+"px"),c.xAxis.dimensionChanged(a.xAxis),c.navbar.dimensionChanged(a.navbar),c.primary.dimensionChanged(a.primary);for(var i=0;i<c.secondaries.length;i++)c.secondaries[i].option.dimensionChanged(d(i))}function k(){return++qa}function l(a){return c(a).width()}
// Inspired by underscore library implementation of debounce
function m(a,b,c){var d,e,f,g,h=function(){var i=(new Date).getTime()-f;b>i&&i>=0?d=setTimeout(h.bind(this),b-i):(d=null,c||(g=a.apply(this,e),e=null))};return function(){e=arguments,f=(new Date).getTime();var i=c&&!d;return d||(d=setTimeout(h.bind(this),b)),i&&(g=a.apply(this,e),e=null),g}}
// Inspired by underscore library implementation of throttle
function n(a,b,c){var d,e,f=null,g=0;c||(c={});var h=function(){g=c.leading===!1?0:(new Date).getTime(),f=null,e=a.apply(this,d),f||(d=null)};return function(){var i=(new Date).getTime();g||c.leading!==!1||(g=i);var j=b-(i-g);return d=arguments,0>=j||j>b?(f&&(clearTimeout(f),f=null),g=i,e=a.apply(this,d),f||(d=null)):f||c.trailing===!1||(f=setTimeout(h.bind(this),j)),e}}function o(c){function d(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function e(){j.translate([0,0]),j.scale(1)}function f(a,b,c){return Math.min(Math.max(a,b),c)}function g(g){var n=b.util.extent().fields("date")(g.datum().data),o=h(n[0]),p=h(n[1]),q=[o,p-c];j.x(h).on("zoom",function(){var b=a.event.translate,c=b[0],o=d(q);c=f(c,-q[1],-q[0]),j.translate([c,0]);var p=1===j.scale(),r=1!==j.scale();if(p&&k||r&&l){var s=h.domain();o?s=n:r&&m&&(s=ra.domain.moveToLatest(s,g.datum().data)),s[0].getTime()!==s[1].getTime()?i.zoom(s):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
e()}else e()}),g.call(j)}var h,i=a.dispatch("zoom"),j=a.behavior.zoom(),k=!0,l=!0,m=!0;return g.allowPan=function(a){return arguments.length?(k=a,g):k},g.allowZoom=function(a){return arguments.length?(l=a,g):l},g.trackingLatest=function(a){return arguments.length?(m=a,g):m},g.scale=function(a){return arguments.length?(h=a,g):h},a.rebind(g,i,"on"),g}function p(){function c(b){b.each(function(c){f.discontinuityProvider(c.discontinuity);var g=a.select(this).datum(c.data).call(k),i=o(d).scale(f).trackingLatest(h).on("zoom",function(a){e[sa.viewChange](a)});g.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var d,e=a.dispatch(sa.viewChange),f=b.scale.dateTime(),g=a.scale.linear(),h=!0,i=60,j=b.series.multi(),k=b.chart.cartesian(f,g).plotArea(j).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:i});return c.trackingLatest=function(a){return arguments.length?(h=a,c):h},a.rebind(c,e,"on"),a.rebind(c,j,"series","mapping","decorate"),a.rebind(c,k,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),c.dimensionChanged=function(a){d=ra.width(a.node())-i},c}function q(){function c(a){var c=a.datum();g(c.data);var d=b.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(c.data.map(function(a){return a.macd}));h.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c).call(h)}var d=a.dispatch(sa.viewChange),e=b.annotation.line().value(0).label(""),f=b.indicator.renderer.macd(),g=b.indicator.algorithm.macd(),h=p().series([e,f]).yTicks(5).mapping(function(a){return a===e?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(sa.viewChange,function(a){d[sa.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function r(){function c(a){var b=a.datum();f(b.data),h.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b).call(h)}var d=a.dispatch(sa.viewChange),e=b.indicator.renderer.relativeStrengthIndex(),f=b.indicator.algorithm.relativeStrengthIndex(),g=[e.lowerValue(),50,e.upperValue()],h=p().series([e]).yTickValues(g).on(sa.viewChange,function(a){d[sa.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function s(){function c(a){a.each(function(c){var d=b.util.extent().fields("volume").pad(.08)(c.data);d[0]<0&&(d[0]=0),f.yTickFormat(c.product.volumeFormat).trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.datum(c).call(f)})}var d=a.dispatch(sa.viewChange),e=b.series.bar().xValue(function(a){return a.date}).yValue(function(a){return a.volume}),f=p().series([e]).yTicks(4).on(sa.viewChange,function(a){d[sa.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){f.dimensionChanged(a)},c}function t(){function c(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function d(a){return a.extent()[0][0]-a.extent()[1][0]===0}function e(a,c){var d=a.selectAll("defs").data([0]).enter().append("defs");d.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:g,height:j}),u.domain(b.util.extent().fields("date")(c)),B.domain(b.util.extent().fields(["low","high"]).pad(r)(c)),a.select("mask").datum(c).call(C)}function f(a){var f=a.datum();t.discontinuityProvider(f.discontinuity),u.discontinuityProvider(f.discontinuity),w.discontinuityProvider(f.discontinuity),e(a,f.data),w.domain(f.viewDomain);var h=ra.domain.filterDataInDateRange(b.util.extent().fields("date")(f.data),f.data),i=b.util.extent().fields(["low","high"]).pad(r)(h);v.xDomain(b.util.extent().fields("date")(f.data)).yDomain(i),z.on("brush",function(){var b=d(z);
// Hide the bar if the extent is empty
c(a,b),b||s[sa.viewChange]([z.extent()[0][0],z.extent()[1][0]])}).on("brushend",function(){var b=d(z);c(a,!1),b&&s[sa.viewChange](ra.domain.centerOnDate(w.domain(),f.data,z.extent()[0][0]))}),v.plotArea(A),a.call(v);
// Allow to zoom using mouse, but disable panning
var j=o(g).scale(w).trackingLatest(f.trackingLatest).allowPan(!1).on("zoom",function(a){s[sa.viewChange](a)});a.select(".plot-area").call(j)}var g,h=100,i=40,j=h-i,k=2,l=k/2,m=j-l,n=m,p=l+n/2,q=2,r=[0,.04],s=a.dispatch(sa.viewChange),t=b.scale.dateTime(),u=b.scale.dateTime(),v=b.chart.cartesian(t,a.scale.linear()).yTicks(0).margin({bottom:i}),w=b.scale.dateTime(),x=b.series.area().xValue(function(a){return a.date}).yValue(function(a){return a.close}),y=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),z=a.svg.brush(),A=b.series.multi().series([x,y,z]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",m).attr("y",k/2),
// overload d3 styling for the brush handles
// as Firefox does not react properly to setting these through less file.
b.selectAll(".resize.w>rect, .resize.e>rect").attr("width",q).attr("x",-q/2),a.selectAll(".resize.w>rect, .resize.e>rect").attr("height",n).attr("y",l),b.select(".extent").attr("mask",'url("#brush-mask")').attr("fill",'url("#brush-gradient")');
// Adds the handles to the brush sides
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",p).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",p).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==z?this.data:void z.extent([[w.domain()[0],v.yDomain()[0]],[w.domain()[1],v.yDomain()[1]]])}),B=a.scale.linear(),C=b.series.area().xValue(function(a){return a.date}).yValue(function(a){return a.close}).xScale(u).yScale(B);return a.rebind(f,s,"on"),f.dimensionChanged=function(a){g=ra.width(a.node()),w.range([0,g]),u.range([0,g]),B.range([j,0])},f}function u(){function c(b){b.each(function(b){var c=a.select(this),h=c.select("#tooltip");d=b.product.priceFormat,e=b.product.volumeFormat,f=b.period.timeFormat,c.classed("hidden",!b.data),h.layout({flexDirection:"row"}).selectAll(".tooltip").layout({marginRight:40,marginLeft:15}),b.data&&h.datum(b.data).call(g)})}var d,e,f,g=b.chart.tooltip().items([["T",function(a){return f(a.date)}],["O",function(a){return d(a.open)}],["H",function(a){return d(a.high)}],["L",function(a){return d(a.low)}],["C",function(a){return d(a.close)}],["V",function(a){return e(a.volume)}]]);return c}function v(){function c(a){var b=(e.ticks()[1]-e.ticks()[0])/1e3;b<a.seconds?f.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):f.ticks(6)}function d(a){var b=a.datum();e.domain(b.viewDomain),e.discontinuityProvider(b.discontinuity),c(b.period),a.call(f)}var e=b.scale.dateTime(),f=a.svg.axis().scale(e).orient("bottom");return d.dimensionChanged=function(a){e.range([0,ra.width(a.node())])},d}function w(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function x(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a,b){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a,b){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n}function y(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function z(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function A(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function B(){function c(){var a=[s,j.option,t],b=p.map(function(a){return a.option});return a.concat(b,r)}function d(){switch(B.value(n),C.value(n),t.value(n),j.valueString){case"line":case"point":case"area":j.option.yValue(n)}}
// Call when what to display on the chart is modified (ie series, options)
function e(a){j=a.series,n=a.yValueAccessor.option,p=a.indicators,d(),u.series(c()),x.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function f(a){var b=j.option.width(a);r.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function g(a){a.classed("band",!1).selectAll("line").style("stroke-width",null)}function h(a){"candlestick"===j.valueString||"ohlc"===j.valueString?f(a):r.decorate(g)}function i(c){var d=c.datum();d.selectorsChanged&&e(d),x.xDomain(d.viewDomain),v.discontinuityProvider(d.discontinuity),r.snap(b.util.seriesPointSnapXOnly(j.option,d.data)),h(d.data),B(d.data),C(d.data);
// Scale y axis
var f=ra.domain.filterDataInDateRange(x.xDomain(),d.data),g=A(u.series()),i=b.util.extent().fields(g).pad(.08)(f);x.yDomain(i);
// Find current tick values and add close price to this list, then set it explicitly below
var p=n(d.data[d.data.length-1]),q=z(w,[p]);x.yTickValues(q).yDecorate(function(b){var c=b.selectAll(".tick").filter(function(a){return a===p}).classed("close-line",!0),d=18;c.select("path").attr("d",function(b){return a.svg.area()(y(l,d))}),c.select("text").attr("transform","translate("+d/2+",1)")}),s.yTicks(q.length-1),
// Redraw
x.plotArea(u),c.call(x);var t=o(k).scale(v).trackingLatest(d.trackingLatest).on("zoom",function(a){m[sa.viewChange](a)});c.select(".plot-area").call(t)}var j,k,l=60,m=a.dispatch(sa.viewChange,sa.crosshairChange),n=function(a){return a.close},p=[],q=[],r=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?m.crosshairChange(a[0].datum):m.crosshairChange(void 0)}).on("trackingend",function(){m.crosshairChange(void 0)});r.id=ra.uid();var s=b.annotation.gridline().xTicks(0),t=b.annotation.line().orient("horizontal").value(n).label("").decorate(function(a){a.classed("close-line",!0)});t.id=ra.uid();var u=b.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case t:return[this.data[this.data.length-1]];case r:return q;default:return this.data}}),v=b.scale.dateTime(),w=a.scale.linear(),x=b.chart.cartesian(v,w).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:l}),B=b.indicator.algorithm.movingAverage(),C=b.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(i,m,"on"),i.dimensionChanged=function(a){k=ra.width(a.node())-l},i}function C(a){return{displayString:a.display,option:a}}function D(a){return{displayString:a.display,option:a}}function E(){function c(a){var b=a.datum(),c=b.selectedIndex||0,i=b.config,j=e(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[c].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[c].displayString});f(j,i.careted?[0]:[]);var l=g(a,[b.options]),m=h(l,b.options),n=m.enter().on("click",d.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),f=b.util.dataJoin().selector(".caret").element("span").attr("class","caret"),g=b.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),h=b.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(c,d,"on"),c}function F(){function c(a){var c=a.datum().selectedIndex||0,f=e(a,[a.datum().options]);f.enter().append("ul");var g=f.selectAll("li").data(b.util.fn.identity);g.enter().append("li").append("a").attr("href","#").on("click",d.tabClick),g.classed("active",function(a,b){return b===c}).select("a").text(function(a){return a.displayString}),g.exit().remove()}var d=a.dispatch("tabClick"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c}function G(){var b=a.dispatch(sa.dataProductChange,sa.dataPeriodChange,sa.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=E().on("optionChange",b[sa.dataProductChange]),d=F().on("tabClick",b[sa.dataPeriodChange]),e=E().on("optionChange",b[sa.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(C),selectedIndex:h.map(function(a){return a.id}).indexOf(f.selectedProduct.id)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(D),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(D),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[sa.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f}function H(){var b=a.dispatch(sa.primaryChartSeriesChange,sa.primaryChartIndicatorChange,sa.secondaryChartChange),c=E().on("optionChange",b[sa.primaryChartSeriesChange]),d=E().on("optionChange",function(a){a.isPrimary?b[sa.primaryChartIndicatorChange](a):b[sa.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select(".series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select(".indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}function I(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[sa.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(sa.resetToLatest);return a.rebind(b,c,"on"),b}function J(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon bf-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(sa.indicatorChange);return a.rebind(b,c,"on"),b}function K(){var b=a.dispatch(sa.primaryChartIndicatorChange,sa.secondaryChartChange,sa.dataProductChange),c=J().on(sa.indicatorChange,b[sa.primaryChartIndicatorChange]),d=J().on(sa.indicatorChange,b[sa.secondaryChartChange]),e=E().on("optionChange",b[sa.dataProductChange]),f=function(b){b.each(function(b){var f=a.select(this),g=b.products;f.select("#mobile-product-dropdown").datum({config:b.productConfig,options:g.map(C),selectedIndex:g.map(function(a){return a.id}).indexOf(b.selectedProduct.id)}).call(e),f.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),f.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(f,b,"on"),f}function L(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function M(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function N(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(k,a),g[sa.newTrade](k,f)}).on("error",function(a){g[sa.streamingFeedError](a,f)}).on("close",function(a){g[sa.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var l=new Date;f.historicFeed.end(l).candles(j).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[sa.historicFeedError](a,f):(k=c(b),g[sa.historicDataLoaded](k,f),d())}))}var f,g=a.dispatch(sa.newTrade,sa.historicDataLoaded,sa.historicFeedError,sa.streamingFeedError,sa.streamingFeedClose),h=M().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=L(),j=200,k=[];return e.candlesOfData=function(a){return arguments.length?(j=a,e):j},a.rebind(e,g,"on"),e}function O(){var c=a.dispatch(sa.notificationClose),d=b.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),e=b.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),f=function(b){b.each(function(b){var f=a.select(this),g=d(f,[b]);g.enter().html('<div class="messages"></div>');var h=e(g.select(".messages"),b.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){c[sa.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(f,c,"on"),f}function P(a){return{id:ra.uid(),message:a}}function Q(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}}function R(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}}function S(a,b,c,d){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d}}function T(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b}function U(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=T(a)),b}function V(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}}function W(a,b,c){return{productConfig:V(null,!0),mobilePeriodConfig:V(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[]}}function X(a,b){return{primaryIndicators:[],secondaryIndicators:[],productConfig:V(),products:a,selectedProduct:b}}function Y(a,b){return{config:a,options:b}}function Z(a,b){return{data:void 0,product:a,period:b}}function $(a){return{data:[],viewDomain:[],trackingLatest:!0,discontinuity:a}}function _(){return{trackingLatest:!0}}function aa(a,b){var c={data:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0,discontinuity:b},d=a;Object.defineProperty(c,"product",{get:function(){return d},set:function(a){d=a,c.selectorsChanged=!0}});var e=x();e.id=ra.uid();var f=w("Candlestick","candlestick",e);f.option.extentAccessor=["high","low"],Object.defineProperty(c,"series",{get:function(){return f},set:function(a){f=a,c.selectorsChanged=!0}});var g={option:function(a){return a.close}};Object.defineProperty(c,"yValueAccessor",{get:function(){return g},set:function(a){g=a,c.selectorsChanged=!0}});var h=[];return Object.defineProperty(c,"indicators",{get:function(){return h},set:function(a){h=a,c.selectorsChanged=!0}}),c}function ba(a,b){return{data:[],viewDomain:[],trackingLatest:!0,product:a,discontinuity:b}}function ca(a,b){return{viewDomain:[],period:a,discontinuity:b}}function da(){return{messages:[]}}function ea(){var a,c,d,e=b.data.random.financial().filter(b.data.random.filter.skipWeekends()),f=[86400],g=null,h=function(b){c.setHours(0,0,0,0);var d=864e5,f=5*d,g=Math.floor((a-1)/5),h=Math.floor((a-1)%5);e.startDate(new Date(c-g*f-h*d));
// dataGenerator.startDate(new Date(end - (candles - 1) * millisecondsPerDay));
var i=e(142);b(null,i)};return h.candles=function(b){return arguments.length?(a=b,h):a},h.end=function(a){return arguments.length?(c=a,h):c},h.granularity=function(a){if(!arguments.length)return d;if(-1===f.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return d=a,h},h.product=function(a){if(!arguments.length)return h;if("Data Generator"!==a)throw new Error("Random Financial Data Generator does not support products.");return g=a,h},h.apiKey=function(){throw new Error("Not implemented.")},h}function fa(){var c,d=1e3,e=b.data.feed.coinbase(),f=m(function(b){var d=a.time.second.offset(e.end(),-c*e.granularity());e.start(d),e(b)},d);return f.candles=function(a){return arguments.length?(c=a,f):c},f.apiKey=function(){throw new Error("Not implemented.")},a.rebind(f,e,"end","granularity","product"),f}function ga(a){var b;return a&&(b=a.message),b}
// https://docs.exchange.coinbase.com/#websocket-feed
function ha(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.exchange.coinbase.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){
// Only close the WebSocket if it is opening or open
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function ia(){function c(a){var b=i.get(a);return b||(b=a[0].toLowerCase()+a.substr(1)),b}function d(b){var c=a.time.second.offset(g.end(),-f*e);g.start(c).collapse(h.get(e)),g(b)}var e,f,g=b.data.feed.quandl().database("WIKI").columnNameMap(c),h=a.map();h.set(86400,"daily"),h.set(604800,"weekly");
// Map fields for WIKI database, to use all adjusted values
var i=a.map();return i.set("Open","unadjustedOpen"),i.set("High","unadjustedHigh"),i.set("Low","unadjustedLow"),i.set("Close","unadjustedClose"),i.set("Volume","unadjustedVolume"),i.set("Adj. Open","open"),i.set("Adj. High","high"),i.set("Adj. Low","low"),i.set("Adj. Close","close"),i.set("Adj. Volume","volume"),d.candles=function(a){return arguments.length?(f=a,d):f},d.granularity=function(a){if(!arguments.length)return e;if(!h.has(a))throw new Error("Granularity of "+a+" is not supported.");return e=a,d},b.util.rebind(d,g,{end:"end",product:"dataset",apiKey:"apiKey"}),d}function ja(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function ka(){function c(){return{week1:Ba.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:Ba.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:Ba.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:Ba.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:Ba.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:Ba.data.source(ea(),null,null),bitcoin:Ba.data.source(fa(),ga,ha(),U),quandl:Ba.data.source(ia(),ja,null,null)}}function e(){return{generated:Ba.data.product("Data Generator","Data Generator",[k.day1],l.generated,".3s"),quandl:Ba.data.product("GOOG","GOOG",[k.day1,k.week1],l.quandl,".3s")}}function f(){var a=x();a.id=ra.uid();var c=Ba.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=ra.uid();var e=Ba.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=ra.uid();var g=Ba.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=ra.uid();var i=Ba.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=ra.uid();var k=Ba.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=Ba.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return Ba.menu.selector(l,m)}function g(){var a=ua.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=ra.uid();var d=Ba.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=ra.uid();var f=Ba.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=[d,f,Ba.menu.option("Relative Strength Index","rsi",a.rsi(),"bf-icon-rsi-indicator",!1),Ba.menu.option("MACD","macd",a.macd(),"bf-icon-macd-indicator",!1),Ba.menu.option("Volume","volume",a.volume(),"bf-icon-bar-series",!1)];return g}function h(){var a=Ba.menu.dropdownConfig("Add Indicator",!1,!0);return Ba.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}function j(a){return ra.discontinuityProvider(a,n)}var k=c(),l=d(),m=e(),n=[l.quandl],o=j(m.generated.source);return{periods:k,sources:l,discontinuousSources:n,primaryChart:Ba.chart.primary(m.generated,o),secondaryChart:Ba.chart.secondary(m.generated,o),selectors:i(),xAxis:Ba.chart.xAxis(k.day1,o),nav:Ba.chart.nav(o),navReset:Ba.chart.navigationReset(),headMenu:Ba.menu.head([m.generated,m.quandl],m.generated,k.day1),legend:Ba.chart.legend(m.generated,k.day1),overlay:Ba.menu.overlay([m.generated,m.quandl],m.generated),notificationMessages:Ba.notification.messages()}}function la(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function ma(a,b,c,d){return a.map(function(a){return Ba.data.product(a.id,a.id,d.get(a.id)||c,b)})}function na(){function c(){X&&(X=!1),Z&&H.suspendLayout(!1),H.primary.datum(R.primaryChart).call(T.primary),H.legend.datum(R.legend).call(T.legend),H.secondaries.datum(R.secondaryChart).filter(function(a,b){return b<T.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container secondary-"+T.secondaries[c].valueString).call(T.secondaries[c].option)}),H.xAxis.datum(R.xAxis).call(T.xAxis),H.navbar.datum(R.nav).call(T.navbar),H.app.select("#navbar-reset").datum(R.navReset).call(K),H.app.select(".head-menu").datum(R.headMenu).call(J),H.app.selectAll(".selectors").datum(R.selectors).call(L),H.app.select("#notifications").datum(R.notificationMessages).call(M),H.overlay.datum(R.overlay).call(I),Z&&(H.suspendLayout(!0),Z=!1)}function d(){Z=!0,ra.layout(H,T)}function e(){a.select(window).on("resize",function(){d(),Y()})}function f(a){R.notificationMessages.messages.unshift(P(a))}function g(a){var b=[a[0],a[1]];R.primaryChart.viewDomain=b,R.secondaryChart.viewDomain=b,R.xAxis.viewDomain=b,R.nav.viewDomain=b;var c=ra.domain.trackingLatestData(R.primaryChart.viewDomain,R.primaryChart.data);R.primaryChart.trackingLatest=c,R.secondaryChart.trackingLatest=c,R.nav.trackingLatest=c,R.navReset.trackingLatest=c,Y()}function h(a){a.isSelected=!a.isSelected,A(),Y()}function i(a){a.isSelected=!a.isSelected,C(),Y()}function j(a){R.legend.data=a,Y()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):U(a),c&&(f(c),Y())}function l(){var a=R.primaryChart.data,c=b.util.extent().fields("date")(a),d=ra.domain.moveToLatest(c,a,W);g(d)}function m(a,b){var c='<div class="spinner"></div>',d='<div class="content alert alert-info">'+b+"</div>";H.app.select("#loading-status-message").classed("hidden",!(a||b)).html(b?d:c)}function n(a){R.primaryChart.data=a,R.secondaryChart.data=a,R.nav.data=a}function o(a){var b=ra.discontinuityProvider(a,R.discontinuousSources);R.xAxis.discontinuity=b,R.nav.discontinuity=b,R.primaryChart.discontinuity=b,R.secondaryChart.discontinuity=b}function p(a){R.headMenu.selectedProduct=a,R.primaryChart.product=a,R.secondaryChart.product=a,R.legend.product=a,R.overlay.selectedProduct=a,o(a.source)}function q(a){R.headMenu.selectedPeriod=a,R.xAxis.period=a,R.legend.period=a}function r(a){m(!0),p(a),q(a.periods[0]),S(a.periods[0].seconds,a)}function s(){return ua.primary().on(sa.crosshairChange,j).on(sa.viewChange,g)}function t(){return ua.nav().on(sa.viewChange,g)}function u(){return va.navigationReset().on(sa.resetToLatest,l)}function v(){return N().on(sa.newTrade,function(a,b){if(n(a),R.primaryChart.trackingLatest){var c=ra.domain.moveToLatest(R.primaryChart.viewDomain,R.primaryChart.data);g(c)}}).on(sa.historicDataLoaded,function(a,b){m(!1),n(a),R.legend.data=null,l(),d()}).on(sa.historicFeedError,function(a,b){m(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),e=b.historicNotificationFormatter(d);e&&(c=". "+e)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;f(i),Y()}).on(sa.streamingFeedError,k).on(sa.streamingFeedClose,k)}function w(){return va.head().on(sa.dataProductChange,function(a){r(a.option),Y()}).on(sa.dataPeriodChange,function(a){m(!0),q(a.option),S(a.option.seconds),Y()}).on(sa.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){R.primaryChart.indicators.forEach(y),T.secondaries.forEach(y),A(),C(),Y()})}function x(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function y(a){a.isSelected=!1}function z(){return va.selectors().on(sa.primaryChartSeriesChange,function(a){R.primaryChart.series=a,x(a,R.selectors.seriesSelector.options),Y()}).on(sa.primaryChartIndicatorChange,h).on(sa.secondaryChartChange,i)}function A(){R.primaryChart.indicators=R.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),R.overlay.primaryIndicators=R.primaryChart.indicators}function B(){T.secondaries=R.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
T.secondaries.forEach(function(a){a.option.on(sa.viewChange,g)}),R.overlay.secondaryIndicators=T.secondaries}function C(){B(),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
H.secondaries.selectAll("*").remove(),d()}function D(){return va.overlay().on(sa.primaryChartIndicatorChange,h).on(sa.secondaryChartChange,i).on(sa.dataProductChange,function(a){r(a.option),Y()})}function E(a){R.notificationMessages.messages=R.notificationMessages.messages.filter(function(b){return b.id!==a}),Y()}function F(){return wa.toast().on(sa.notificationClose,E)}function G(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;R.notificationMessages.messages.unshift(P(e))}else{var f=[R.periods.hour1,R.periods.day1],g=a.map();g.set("BTC-USD",[R.periods.minute1,R.periods.minute5,R.periods.hour1,R.periods.day1]);var h=ma(c,R.sources.bitcoin,f,g);R.headMenu.products=R.overlay.products=R.headMenu.products.concat(h)}Y()}var H,I,J,K,L,M,O='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',Q={},R=ka(),S=v(),T={primary:void 0,secondaries:[],xAxis:ua.xAxis(),navbar:void 0,legend:ua.legend()},V=!1,W=.2,X=!0,Y=b.util.render(c),Z=!0;return Q.fetchCoinbaseProducts=function(a){return arguments.length?(V=a,Q):V},Q.changeQuandlProduct=function(a){var b=xa.product(a,a,[R.periods.day1],R.sources.quandl,".3s"),c=R.headMenu.products.some(function(a){return a.id===b.id}),d=R.overlay.products.some(function(a){return a.id===b.id});c||R.headMenu.products.push(b),d||R.overlay.products.push(b),r(b),X||Y()},Q.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(W=a,Q):W},Q.indicators=function(a){if(!arguments.length){var b=[];return R.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return R.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),A(),X?B():(C(),Y()),Q},Q.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(O);var f=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");H={app:c,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},T.primary=s(),T.navbar=t(),J=w(),K=u(),L=z(),I=D(),M=F(),d(),e(),S(R.headMenu.selectedPeriod.seconds,R.headMenu.selectedProduct),V?la(G):R.sources.bitcoin&&delete R.sources.bitcoin},b.util.rebind(Q,R.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),b.util.rebind(Q,S,{periodsOfDataToFetch:"candlesOfData"}),Q}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c;var oa={centerOnDate:d,filterDataInDateRange:e,moveToLatest:h,trackingLatestData:i},pa=!1,qa=0,ra={domain:oa,layout:j,uid:k,width:l,debounce:m,throttle:n,discontinuityProvider:g},sa={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},ta={base:p,macd:q,rsi:r,volume:s},ua={legend:u,nav:t,primary:B,xAxis:v,secondary:ta},va={head:G,selectors:H,navigationReset:I,overlay:K},wa={toast:O},xa={period:Q,product:R,source:S},ya={head:W,periodAdaptor:D,productAdaptor:C,overlay:X,dropdownConfig:V,option:w,selector:Y},za={legend:Z,nav:$,navigationReset:_,primary:aa,secondary:ba,xAxis:ca},Aa={message:P,messages:da},Ba={menu:ya,chart:za,data:xa,notification:Aa},Ca={app:na},Da=window.location.search.split("seed=")[1];Da&&Math.seedrandom(Da),Ca.app().fetchCoinbaseProducts(!0).run("#app-container")});